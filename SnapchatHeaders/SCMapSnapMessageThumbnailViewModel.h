...
- (id)initWithChatMetadata:(id)arg1 isSendingOrHasFailed:(_Bool)arg2 senderColor:(id)arg3 messageId:(id)arg4 conversationId:(id)arg5 enableStreaming:(_Bool)arg6;
- (id)initWithMapSnapMessage:(id)arg1 senderColor:(id)arg2 enableStreaming:(_Bool)arg3;
