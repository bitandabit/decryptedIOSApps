...
- (id)generateAutoFillFieldSearchJsString:(id)arg1 resultVariableName:(id)arg2;
...
- (void)searchAutoFillFieldsWithCompletionBlock:(CDUnknownBlockType)arg1;
- (void)autoDetectAutofillAndLaunchPromptIfNecessary;
- (void)setUpOnEditAutofill;
- (void)userContentController:(id)arg1 didReceiveScriptMessage:(id)arg2;
- (id)initWithUserInfoProvider:(id)arg1 allowAutoDetectAutofill:(_Bool)arg2 allowAutoDetectZipCodeAutofill:(_Bool)arg3 allowOnEditAutofill:(_Bool)arg4 onEditAutofillType:(long long)arg5;
