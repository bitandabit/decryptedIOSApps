...
#import "SCMyFriendsHeaderDelegate-Protocol.h"
...
@class AddFriendsDelegateObject, EGORefreshTableHeaderView, Friend, NSArray, NSDictionary, NSIndexPath, NSMutableArray, NSMutableSet, NSString, SCAlertGear, SCContactsAccessViewController, SCMyFriendsHeader, SCSearchFriendsSubViewController, SCTableIndexController, SCUserSession, UITableView;
...
- (_Bool)_shouldShowFriendsTableIndex;
...
- (void)loadView;
- (id)initWithSendSnapNavigationControllerDelegate:(id)arg1 startChatDelegate:(id)arg2 userSession:(id)arg3 profilePageType:(long long)arg4 sourcePageName:(id)arg5 fromQuickAction:(_Bool)arg6 skipPhoneVerification:(_Bool)arg7 fromPXPrompt:(_Bool)arg8;
- (id)initWithSendSnapNavigationControllerDelegate:(id)arg1 startChatDelegate:(id)arg2 userSession:(id)arg3 profilePageType:(long long)arg4 sourcePageName:(id)arg5 skipPhoneVerification:(_Bool)arg6 fromPXPrompt:(_Bool)arg7;
- (id)initWithSendSnapNavigationControllerDelegate:(id)arg1 startChatDelegate:(id)arg2 userSession:(id)arg3 profilePageType:(long long)arg4 sourcePageName:(id)arg5 skipPhoneVerification:(_Bool)arg6;
