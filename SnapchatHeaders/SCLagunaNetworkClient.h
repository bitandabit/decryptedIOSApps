...
@class NSString, SCLagunaAEADPacketEncryptor, SCLagunaMessageBuffer, SCLagunaStream, SCWeakTimer, VLKAmbaResponse;
@protocol SCLagunaNetworkClientDelegate;

@interface SCLagunaNetworkClient : NSObject <SCLagunaStreamDelegate, SCLagunaMessageBufferDelegate, SCLagunaNetworkClient>
{
