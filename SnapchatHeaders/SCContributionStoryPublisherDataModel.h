...
@property(readonly, nonatomic) _Bool isInsideChatV3; // @synthesize isInsideChatV3=_isInsideChatV3;
...
- (id)initWithUserName:(id)arg1 displayName:(id)arg2 subtext:(id)arg3 profileDescription:(id)arg4 thumbnailUrl:(id)arg5 cacheId:(id)arg6 storyType:(long long)arg7 isInsideChatV3:(_Bool)arg8;
