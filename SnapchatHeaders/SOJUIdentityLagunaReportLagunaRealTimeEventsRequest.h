...
#import "SOJUIdentityLagunaReportLagunaRealTimeEventsRequest-Protocol.h"
...
@property(readonly, copy, nonatomic) NSArray *eventList; // @synthesize eventList=_eventList;
