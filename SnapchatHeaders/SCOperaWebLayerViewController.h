...
@class NSMutableArray, NSMutableDictionary, NSString, SCOperaInlineVideo, SCOperaRemoteVideoViewController, UILongPressGestureRecognizer, UITapGestureRecognizer, UIView;
