...
- (id)createV2TypeReleaseMessageForParticipant:(id)arg1 modifyConversation:(id)arg2 releaseType:(long long)arg3 knownChatSequenceNumbers:(struct NSDictionary *)arg4;
