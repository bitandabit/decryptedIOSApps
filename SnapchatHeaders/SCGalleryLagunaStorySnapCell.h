...
@class CAShapeLayer, NSString, SCGalleryLagunaContentLoader, SCGalleryLagunaStorySnapCellModel, SCGalleryLagunaStorySnapCellProgressView, UIImageView, UIView;
...
@property(readonly, nonatomic) unsigned long long selectMode; // @synthesize selectMode=_selectMode;
...
- (void)setSnap:(id)arg1 entry:(id)arg2 mediaScenePath:(CDStruct_bac8f6e9)arg3 selectMode:(unsigned long long)arg4 userSession:(id)arg5 shouldShowIndicator:(_Bool)arg6;
