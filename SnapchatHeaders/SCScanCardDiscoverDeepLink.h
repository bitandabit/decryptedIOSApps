...
@class NSString, SCAlertTitleView, SCLoadingIndicatorView, SCScanCardButton, SCScanCardDeepLinkData, SCUserProperties_DEPRECATED, UIActivityIndicatorView, UIButton, UIColor, UIImageView, UILabel, UIView;
