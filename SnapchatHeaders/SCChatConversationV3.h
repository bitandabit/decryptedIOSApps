...
@property(readonly, nonatomic) _Bool recipientCanReceiveCash; // @synthesize recipientCanReceiveCash=_recipientCanReceiveCash;
...
- (id)getSentMessagesFrom:(struct NSDictionary *)arg1 upTo:(struct NSDictionary *)arg2 withMinVersion:(unsigned long long)arg3;
