...
@class NSMutableArray, NSMutableDictionary, NSString, SASAudioStitch, SCContextContextHint, SCLocalizedStringSet, SCMTOneSnapInfo, SCMTPublicMediaInfo, SCMTStreamingMediaInfo;
