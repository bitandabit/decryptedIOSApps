...
@class NSData, NSNumber, NSString, SOJUGallerySnapOverlay;
...
- (id)initWithSojuOverlay:(id)arg1 renderedOverlay:(id)arg2 originalMedia:(id)arg3 mediaType:(id)arg4 mediaFormat:(id)arg5;
