...
#import "SCGroupMiniProfileHeaderRowControllerDelegate-Protocol.h"
...
@interface SCGroupMiniProfileParticipantsSectionController : SCMiniProfileSectionController <SCGroupMiniProfileHeaderRowControllerDelegate, SCMiniProfileFooterRowControllerDelegate, SCMiniProfileFriendRowControllerDelegate>
{
...
- (void)headerRowControllerDidTap:(id)arg1;
