...
@class CAShapeLayer, NSMutableArray, SCCropTransparentTouchableView, SCCroppingState, SCGrowingButton, UIImageView;
...
- (void)_animateTouchControlViewToTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3 performHaptic:(_Bool)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_animateTouchControlViewToTranslation:(struct CGPoint)arg1 rotation:(double)arg2 scale:(double)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)scaleToAspectFillWithCompletion:(CDUnknownBlockType)arg1;
...
- (_Bool)canUndoState;
- (void)undoStateWithCompletion:(CDUnknownBlockType)arg1;
