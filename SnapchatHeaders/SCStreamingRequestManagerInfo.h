...
@class NSArray, SCStreamingRequestTrackingInfo;
...
- (id)initWithRequestContexts:(id)arg1 priority:(long long)arg2 fallbackPriority:(long long)arg3 connectivity:(long long)arg4 requestType:(long long)arg5 trackingInfo:(id)arg6;
