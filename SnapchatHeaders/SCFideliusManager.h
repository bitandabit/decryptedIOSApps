...
@class NSMutableSet, NSString, SCEllipticCurveCrypto, SCFideliusDeviceGraphManager, SCFideliusLogger, SCFideliusServiceProvider, SCFideliusUserDatabaseManager, SCFideliusUserIdentity, SCUserSession, User;
...
@interface SCFideliusManager : NSObject <SCFideliusDataProvider, SCUserSessionScoped, SCTimeProfilable, SCFideliusProtocol>
{
    ...
    _Bool _isStudySet;
    _Bool _isCleartextEnabled;
    _Bool _waitingForDbTransition;
    _Bool _fetchConversationQueued;
