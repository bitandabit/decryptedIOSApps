...
- (id)initTouchPointTrackingWithVideoDuration:(double)arg1 videoTracker:(id)arg2 initialTransform:(id)arg3 size:(struct CGSize)arg4 frameTime:(CDStruct_1b6d18a9)arg5 centerPoint:(struct CGPoint)arg6;
