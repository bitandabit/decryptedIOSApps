...
- (id)initWithIdValue:(id)arg1 imageFilter:(id)arg2 name:(id)arg3 scheduledStart:(id)arg4 scheduledEnd:(id)arg5 submissionTime:(id)arg6 status:(id)arg7 productType:(id)arg8 lensPreviewThumbnailImage:(id)arg9 assetDraft:(id)arg10;
- (id)toJson;
- (id)toDictionary;
