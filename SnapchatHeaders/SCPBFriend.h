...
@class NSMutableArray, NSMutableDictionary, NSString, SCPBSecurityFideliusFriendInfo;
...
@property(copy, nonatomic) NSString *addSourceType; // @dynamic addSourceType;
...
@property(nonatomic) _Bool canBeSharedByFriends; // @dynamic canBeSharedByFriends;
...
@property(retain, nonatomic) SCPBSecurityFideliusFriendInfo *fideliusInfo; // @dynamic fideliusInfo;
...
@property(nonatomic) _Bool hasFideliusInfo; // @dynamic hasFideliusInfo;
...
@property(nonatomic) int pendingChatsCount; // @dynamic pendingChatsCount;
@property(nonatomic) int pendingSnapsCount; // @dynamic pendingSnapsCount;
@property(nonatomic) int potentialHighQualityScore; // @dynamic potentialHighQualityScore;
