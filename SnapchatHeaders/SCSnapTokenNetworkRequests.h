...
- (void)_snapSessionHttpSuccessWithResponseDictionary:(id)arg1 successBlock:(CDUnknownBlockType)arg2 failureBlock:(CDUnknownBlockType)arg3;
- (id)_buildAccessTokenSojuRequestForRefreshToken:(id)arg1 serverScopeNames:(id)arg2;
- (void)_accessTokenSuccessWithSojuResponse:(id)arg1 successBlock:(CDUnknownBlockType)arg2 failureBlock:(CDUnknownBlockType)arg3;
- (void)_accessTokenHttpSuccessForResponseDictionary:(id)arg1 successBlock:(CDUnknownBlockType)arg2 failureBlock:(CDUnknownBlockType)arg3;
