...
@class SCOperaAttachmentInteractionController;
...
- (_Bool)attachmentInteractionController:(SCOperaAttachmentInteractionController *)arg1 shouldBeginWithSwipeDirection:(unsigned long long)arg2;
@end
