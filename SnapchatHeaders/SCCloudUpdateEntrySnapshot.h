...
- (id)initWithProfile:(id)arg1 entryId:(id)arg2 title:(id)arg3 deletedSnapId:(id)arg4 snapPlaceholder:(id)arg5 detailPlaceholder:(id)arg6 miniThumbnailPlaceholder:(id)arg7 dataVaultEncryption:(id)arg8 userContext:(id)arg9 requiresSyncStatusUpdate:(_Bool)arg10;
