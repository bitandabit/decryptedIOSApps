...
@property(nonatomic) _Bool shouldEnableUserTagging; // @synthesize shouldEnableUserTagging=_shouldEnableUserTagging;
...
- (void)prepareCaptionStyle:(id)arg1 completeBlock:(CDUnknownBlockType)arg2;
