...
@class NSIndexPath, SCSearchActionModel, SCSearchCarouselContainerCollectionViewCell, UICollectionViewCell, UIView;

@protocol SCSearchCarouselContainerCollectionViewCellDelegate <NSObject>
- (void)searchCarouselContainerCollectionViewCell:(SCSearchCarouselContainerCollectionViewCell *)arg1 didTriggerActionOnItemAtIndexPath:(NSIndexPath *)arg2 withActionModel:(SCSearchActionModel *)arg3 fromSourceView:(UIView *)arg4;
