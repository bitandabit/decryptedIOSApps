...
@class FriendStories, MGLMapView, NSArray, NSDictionary, NSString, SCContextSession, SCMTPointOfInterest, SCMapTapToPlayLogger, SCMapTapToPlayPOIMediaFetcher, SCMapTapToPlayPresenter, SCStatusBarOverlayLabelWindow, SCUserSession, SCXRenderLayer;
