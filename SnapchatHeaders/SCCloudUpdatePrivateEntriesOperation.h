...
- (id)logParameters;
- (void)_updateEntriesFromSequenceNumber:(long long)arg1 networker:(id)arg2 logger:(id)arg3 queue:(id)arg4 snapsUploadInfo:(id)arg5 failureHandler:(CDUnknownBlockType)arg6 successHandler:(CDUnknownBlockType)arg7;
- (id)description;
