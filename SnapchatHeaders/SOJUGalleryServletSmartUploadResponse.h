...
#import "SOJUGalleryServletSmartUploadResponse-Protocol.h"

@class NSNumber, NSString, SOJUGalleryServletQuota;

@interface SOJUGalleryServletSmartUploadResponse : NSObject <SOJUGalleryServletSmartUploadResponse>
{
...
- (id)initWithServiceStatusCode:(id)arg1 userString:(id)arg2 backoffTime:(id)arg3 debugInfo:(id)arg4 quota:(id)arg5 totalEntryCount:(id)arg6 statusCode:(id)arg7;
- (id)toJson;
- (id)toDictionary;
