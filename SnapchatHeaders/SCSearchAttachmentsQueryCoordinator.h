...
@class NSString, SCSearchAttachmentsActionHandler, SCSearchAttachmentsDataProvider, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, SCSearchQuery, SCSearchSession;

@interface SCSearchAttachmentsQueryCoordinator : NSObject <SCSearchEventListener, SCSearchQueryCoordinating>
{
