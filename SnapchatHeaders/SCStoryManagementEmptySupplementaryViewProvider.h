...
@interface SCStoryManagementEmptySupplementaryViewProvider : NSObject <SCSearchCollectionViewSectionSupplementaryViewProviding, SCSearchCollectionViewSupplementaryViewModelsConfigurable>
{
