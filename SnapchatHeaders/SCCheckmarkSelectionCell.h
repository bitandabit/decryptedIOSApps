...
- (void)setCellSelected:(_Bool)arg1 sourcePage:(unsigned long long)arg2 animated:(_Bool)arg3;
- (void)setCellSelected:(_Bool)arg1 sourcePage:(unsigned long long)arg2;
- (void)_setupCircle;
