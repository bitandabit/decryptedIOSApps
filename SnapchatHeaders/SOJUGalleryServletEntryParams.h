...
- (id)initWithEntryId:(id)arg1 entryType:(id)arg2 snapIds:(id)arg3 snapsUploadInfo:(id)arg4 highlightedSnapIds:(id)arg5 seqNum:(id)arg6 createTime:(id)arg7 title:(id)arg8 isPrivate:(id)arg9 lastAutosaveTime:(id)arg10 externalId:(id)arg11 snapOperations:(id)arg12 entrySource:(id)arg13;
- (id)toJson;
- (id)toDictionary;
