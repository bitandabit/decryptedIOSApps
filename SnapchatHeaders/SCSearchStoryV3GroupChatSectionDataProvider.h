...
@class NSArray, NSString, SCSearchEventListenerAnnouncer, SCSearchFriendProvider;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCSearchStoryV3GroupChatSectionDataProvider : NSObject <SCSearchSectionDataProviding>
{
    SCSearchFriendProvider *_friendProvider;
    NSArray *_groupChatViewCardModels;
...
- (void).cxx_destruct;
- (void)_configureGroupChatCardCollectionViewCell:(id)arg1;
...
- (id)initWithFriendProvider:(id)arg1;
