...
@class NSString, SCLensLogger, SCLensSubPickerView, UICollectionView, UIView;
...
@property(readonly, nonatomic) SCLensLogger *lensLogger; // @synthesize lensLogger=_lensLogger;
- (void).cxx_destruct;
