...
@class NSString, SCGalleryActivityController, SCGalleryCellActionMenu, SCGalleryPreviewController, SCGalleryPrivateGallerySetupFlow, SCGallerySendController, SCUserSession, UINavigationController, UIView;
...
@interface SCGalleryCellActionMenuHelper : NSObject <SCGalleryCellActionMenuDelegate, SCGalleryCellActionMenuDataSource, SCGalleryPreviewControllerDelegate, SCGallerySelectEntriesViewControllerDelegate, UIViewControllerTransitioningDelegate, SCGalleryPrivateGallerySetupFlowDelegate>
{
...
- (id)galleryCellActionMenuTransferSession:(id)arg1 item:(id)arg2;
...
- (void)presentActionMenuForItem:(id)arg1 snap:(id)arg2 sourcePageName:(id)arg3 sourceView:(id)arg4 sourceImage:(id)arg5 page:(long long)arg6 navigationController:(id)arg7 topInset:(double)arg8;
- (void)handleLongPress:(id)arg1 item:(id)arg2 snap:(id)arg3 sourcePageName:(id)arg4 sourceView:(id)arg5 sourceImage:(id)arg6 page:(long long)arg7 navigationController:(id)arg8 topInset:(double)arg9;
- (void)_setupActionMenuForItem:(id)arg1 snap:(id)arg2 sourceView:(id)arg3 sourceImage:(id)arg4 page:(long long)arg5;
