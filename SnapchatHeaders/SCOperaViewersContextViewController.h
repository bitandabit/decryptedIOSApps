...
@protocol SCOperaViewersContextViewControllerDelegate, UIScrollViewDelegate;

@interface SCOperaViewersContextViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, SCOperaViewersContextHeaderViewDelegate>
{
