...
@class NSArray, NSError, NSMutableDictionary, NSString, SCFloatLabeledTextField, SCLoadingIndicatorView, SCPaymentsPageLogger, SCPaymentsShippingAddress, SCUserSession, UIButton, UIColor, UIFont, UILabel, UIScrollView, UIView, UIViewController, UIVisualEffectView;
