...
@class NSIndexPath, NSString, UICollectionView, UICollectionViewLayout, UIView;
...
@property(retain) id <SCStickerPickerV2IconsControllerDelegate> delegate; // @synthesize delegate=_delegate;
