...
@class NSString, SCGradientView, SCLazy, SCSearchActionModel, SCSearchEventListenerAnnouncer, SCSearchNetworkImageView, SCSearchNetworkVideo, SCSearchNetworkVideoView, SCSearchStoryIcon, SCSearchStreamingMediaInfo, SCSearchVideoStreamingView, UILabel;
