...
@property(readonly, nonatomic) SCLagunaHardwareVersion *hardwareVersion; // @synthesize hardwareVersion=_hardwareVersion;
@property(readonly, nonatomic) SCLagunaFirmwareVersion *firmwareVersion; // @synthesize firmwareVersion=_firmwareVersion;
