...
@property(readonly, nonatomic) unsigned int logContext; // @synthesize logContext=_logContext;
...
- (void)insertUnlockables:(id)arg1 forLocation:(id)arg2 fromSources:(id)arg3 completion:(CDUnknownBlockType)arg4;
