...
@class NSString, SOJUAdUnlockableLongformVideoView, SOJUAdUnlockableLongformWebviewView;
...
- (id)initWithLongformVideoImpression:(id)arg1 remoteWebpageImpression:(id)arg2;
- (id)toJson;
- (id)toDictionary;
