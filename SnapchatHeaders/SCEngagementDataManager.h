...
- (void)_updateEngagementData:(id)arg1;
- (void)updateWithNewMessages:(id)arg1;
- (void)_chatDidChange:(id)arg1;
- (void)_incrementOnPerformer:(id)arg1 type:(unsigned long long)arg2 count:(long long)arg3;
- (void)_increment:(id)arg1 type:(unsigned long long)arg2 count:(long long)arg3;
