...
- (void)logFinishedOperationWithParams:(NSDictionary *)arg1 operationType:(unsigned long long)arg2 totalTimeInSec:(double)arg3 networkProcessingTimeInSec:(double)arg4 queueLength:(long long)arg5 logContexts:(NSArray *)arg6 tempCellularBackupEnabled:(_Bool)arg7;
