...
+ (id)lensesInTalkV3LayoutWithParentViewFrame:(struct CGRect)arg1 bottomOffset:(double)arg2;
+ (id)cameraLensesLayoutWithParentViewFrame:(struct CGRect)arg1 bottomOffset:(double)arg2;
...
- (void).cxx_destruct;
- (id)initWithItemDimension:(double)arg1 selectedItemDimension:(double)arg2 collectionViewReusableIdentifier:(id)arg3 collectionViewBottomOffset:(double)arg4 collectionViewHeight:(double)arg5 parentViewFrame:(struct CGRect)arg6;
