...
@class NSString, SCColorPicker, SCDrawingButton, SCDrawingView, SCGradientView, SCGrowingButton, UIColor, UIImage, UIImageView, UIView;
@protocol SCShakeToReportScreenshotEditorViewControllerDelegate;

@interface SCShakeToReportScreenshotEditorViewController : UIViewController <SCColorPickerDelegate, SCDrawingDelegate>
{
    UIImage *_originalImage;
    UIImageView *_originalImageView;
    SCDrawingView *_drawingView;
    id <SCShakeToReportScreenshotEditorViewControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <SCShakeToReportScreenshotEditorViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
