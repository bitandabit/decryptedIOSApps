...
- (void)dealloc;
- (id)initWithRequest:(id)arg1 authenticator:(id)arg2 endpointMigrationInfo:(id)arg3 traceFile:(struct SCNetworkTraceFileStruct *)arg4 networkInterceptors:(id)arg5 completionQueue:(id)arg6 completionBlock:(CDUnknownBlockType)arg7;
