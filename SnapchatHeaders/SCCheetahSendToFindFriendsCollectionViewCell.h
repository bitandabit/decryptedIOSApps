...
@class NSString, SCButton, SCSearchActionModel, UILabel;
@protocol SCSearchActionHandling;

@interface SCCheetahSendToFindFriendsCollectionViewCell : SCSearchCollectionViewCell <SCSearchActionable>
{
    UILabel *_textLabel;
