...
@class NSString, SCScanCardButton, SCStoryPresenter_DEPRECATED, SCUserSession, SOJUScannableActionAdCreativePreview, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIView, UIViewController;
