...
@class NSMutableDictionary, NSMutableSet, NSString, SCGallerySnapsFaceAnalysisOperation, SCProgressOverlayView;

@interface SCGallerySnapsFaceStatusViewController : SCGallerySnapsViewController <SCProgressOverlayViewDelegate>
{
    NSMutableSet *_scannedGallerysnapIds;
    NSMutableDictionary *_snapIdToBoundingBoxes;
...
@property(retain, nonatomic) NSMutableDictionary *snapIdToBoundingBoxes; // @synthesize snapIdToBoundingBoxes=_snapIdToBoundingBoxes;
@property(retain, nonatomic) NSMutableSet *scannedGallerysnapIds; // @synthesize scannedGallerysnapIds=_scannedGallerysnapIds;
- (void).cxx_destruct;
