...
@class NSString, SCLagunaFirmwareVersion;
...
@interface SCLagunaFirmwareTag : NSObject
{
    ...
    SCLagunaFirmwareVersion *_latestVersion;
    SCLagunaFirmwareVersion *_minimumAcceptedVersion;
...
@property(retain, nonatomic) SCLagunaFirmwareVersion *minimumAcceptedVersion; // @synthesize minimumAcceptedVersion=_minimumAcceptedVersion;
@property(retain, nonatomic) SCLagunaFirmwareVersion *latestVersion; // @synthesize latestVersion=_latestVersion;
