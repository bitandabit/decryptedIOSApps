...
@class NSSet, NSString, NSURL, SCSearchNetworkImage;
...
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 publisherFormalName:(id)arg3 filledIconUrl:(id)arg4 deeplinkUrl:(id)arg5 dsnapIds:(id)arg6 thumbnail:(id)arg7 publisherName:(id)arg8 timestampSecs:(double)arg9 publisherId:(long long)arg10 isSubscribed:(_Bool)arg11;
