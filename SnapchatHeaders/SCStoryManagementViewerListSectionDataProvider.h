...
@class NSString, SCSearchEventListenerAnnouncer, SCStoryManagementDataSource;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCStoryManagementViewerListSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding>
{
