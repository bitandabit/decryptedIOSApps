...
- (id)initWithTemplateId:(id)arg1 categoryId:(id)arg2 platform:(id)arg3 imagePngBase64:(id)arg4 textBoxArray:(id)arg5 imageBoxArray:(id)arg6 stickerBoxArray:(id)arg7 templateInstanceId:(id)arg8 productType:(id)arg9;
- (id)toJson;
- (id)toDictionary;
