...
- (id)initWithMediaType:(unsigned long long)arg1 source:(unsigned long long)arg2 originalMediaURL:(id)arg3 renderedOverlayURL:(id)arg4 duration:(double)arg5 createTimeUtc:(id)arg6 orientation:(long long)arg7 sojuOverlay:(id)arg8 framing:(id)arg9 location:(id)arg10 infiniteDuration:(_Bool)arg11 storySnapId:(id)arg12 attributionString:(id)arg13 captureTimeUtc:(id)arg14 mediaFormat:(long long)arg15;
