...
#import "SCBaseMediaFullScreenDelegate-Protocol.h"
...
@class AVPlayer, FBKVOController, FLAnimatedImage, FLAnimatedImageView, NSString, SCAudioStitchPreviewHandler, SCBaseMediaFullScreenView, SCBaseMediaThumbnailViewModel, SCBrowserViewController, SCDiscoverBarView, SCDiscoverDSnapExpirationValidator, SCLoadingIndicatorView, SCPlayerView, SCShazamOperaPresenter, SCUserSession, UIImageView, UILabel, UITapGestureRecognizer, UIViewController, UIWindow;
...
- (_Bool)isDiscoverMessageInChatV3:(id)arg1;
- (_Bool)isDiscoverMessageInChatV2:(id)arg1;
