...
#import "CountryCodePickerViewDelegate-Protocol.h"
...
@class CountryCodePickerView, NSString, NSTimer, SCAuthenticatedPhoneManager, SCLoadingScreen, SCPhoneNumberPlaceholderTextField, SCUserSession, SCVerificationCodeTextField, TTTAttributedLabel, UIButton, UILabel, UIScrollView, UISwitch, UITextField, UIView, UIWindow;
@protocol SCMobileSettingsDelegate;

@interface MobileSettingsViewController : GenericSettingsViewController <CountryCodePickerViewDelegate, UITextFieldDelegate, MFMessageComposeViewControllerDelegate, SCVerificationCodeTextFieldDelegate, UIScrollViewDelegate, TTTAttributedLabelDelegate, SCSettingsPasswordReauthViewControllerDelegate>
{
