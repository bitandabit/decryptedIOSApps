...
@class Media, NSDictionary, NSHTTPURLResponse, SCRequest;
...
- (void)fetchMediaResponseHandlerCustom:(Media *)arg1 request:(SCRequest *)arg2 response:(NSHTTPURLResponse *)arg3;
