...
@class NSDate, NSMutableArray, NSMutableDictionary, NSString, NSTimer, SCAppNotification, SCUserSession;
...
@interface SCAppNotificationSequencer : NSObject <SCAppNotificationProviderDelegate, SCTPhoneCallListener>
{
    ...
    NSMutableDictionary *_bitmojiForNotifications;
...
- (void)enqueueNotificationAfterFetchingBitmojiSelfie:(id)arg1;
