...
- (void)dealloc;
- (id)initWithRequest:(id)arg1 authenticator:(id)arg2 endpointMigrationInfo:(id)arg3 traceFile:(struct SCNetworkTraceFileStruct *)arg4 networkInterceptors:(id)arg5 successQueue:(id)arg6 failureQueue:(id)arg7 successBlock:(CDUnknownBlockType)arg8 failureBlock:(CDUnknownBlockType)arg9;
