...
@class NSString, SCExpandedButton, SCMediaCardViewModel, SCUserSession, UIActivityIndicatorView, UIColor, UIImageView, UILabel, UIView;
...
@property(retain, nonatomic) SCMediaCardViewModel *viewModel; // @synthesize viewModel=_viewModel;
