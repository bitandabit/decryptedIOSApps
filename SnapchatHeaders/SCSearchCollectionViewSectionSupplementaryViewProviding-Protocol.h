...
@protocol SCSearchCollectionViewSectionSupplementaryViewProviding <NSObject>
@property(readonly, nonatomic) long long sectionHeaderDisplayStrategy;
@property(nonatomic) __weak id <SCSearchCollectionViewSectionSupplementaryViewProviderDelegate> supplementaryViewProviderDelegate;
