...
@class NSDate, NSMutableSet, NSString, SCSnapCommonLoggingParameters;
...
- (void)_logStickerPickerSessionWithSticker:(id)arg1 fromSearch:(_Bool)arg2 searchQuery:(id)arg3 bitmojiTabVisible:(_Bool)arg4 sourceTab:(long long)arg5 stickerPickerType:(long long)arg6;
- (void)viewStickerCategoryAtIndex:(id)arg1 type:(long long)arg2;
- (void)logStickerPickerSearchEvent:(id)arg1 results:(id)arg2;
- (void)logStickerPickerSessionEnded:(id)arg1 categoryCell:(id)arg2 searchQuery:(id)arg3 index:(unsigned long long)arg4 bitmojiTabVisible:(_Bool)arg5 tabSource:(long long)arg6 stickerPickerType:(long long)arg7;
