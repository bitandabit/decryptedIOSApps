...
@protocol SCChatCellGestureDelegate><SCChatFullscreenMediaChatTableCellDelegate><SCChatVisibilityProvider, SCChatConversationViewModel, UIScrollViewDelegate;
...
- (void)_fetchMedia:(id)arg1 forMessageId:(id)arg2 conversationId:(id)arg3 senderUsername:(id)arg4 shouldDismissPrefetchRule:(_Bool)arg5;
