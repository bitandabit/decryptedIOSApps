...
#import "SCURLMediaCardViewDelegate-Protocol.h"
#import "TTTAttributedLabelDelegate-Protocol.h"

@class NSArray, NSMutableArray, NSString, SCChatTextLabel, UIViewController;
@protocol SCChatCellMessageStateUpdateDelegate><SCChatCellURLLinkGestureDelegate><SKStoreProductViewControllerDelegate><SCActionSheetDelegate;
