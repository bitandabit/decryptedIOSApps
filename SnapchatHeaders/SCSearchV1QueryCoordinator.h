...
@class NSDictionary, NSString, SCSearchCachedRequestManager, SCSearchDebugQueryCoordinator, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, SCSearchQuery, SCSearchQueryDeduplicator, SCSearchSession, SCSearchSnapFeedQueryCoordinator;
...
@interface SCSearchV1QueryCoordinator : NSObject <SCSearchQueryCoordinating, SCSearchEventAnnouncing>
{
    ...
    SCSearchSnapFeedQueryCoordinator *_snapFeedQueryCoordinator;
