...
@property(copy, nonatomic) SCFriendsFeedCashState *cashState; // @synthesize cashState=_cashState;
...
- (id)initWithRowid:(long long)arg1 userId:(id)arg2 cashState:(id)arg3 chatsState:(id)arg4 snapsState:(id)arg5;
