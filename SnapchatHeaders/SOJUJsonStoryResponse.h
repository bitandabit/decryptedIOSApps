...
#import "SOJUJsonStoryResponse-Protocol.h"

@class NSNumber, NSString, SOJUStory;

@interface SOJUJsonStoryResponse : NSObject <SOJUJsonStoryResponse>
{
    SOJUStory *_story;
...
- (id)initWithStory:(id)arg1 intendedPostTime:(id)arg2;
- (id)toJson;
- (id)toDictionary;
