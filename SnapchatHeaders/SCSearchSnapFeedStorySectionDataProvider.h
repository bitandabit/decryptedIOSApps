...
@class NSString, SCSearchDynamicStory, SCSearchEventListenerAnnouncer, SCSearchImageDownloader;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCSearchSnapFeedStorySectionDataProvider : NSObject <SCSearchSectionDataProviding>
{
...
- (void)_updateWithSnapFeedStory:(id)arg1;
