...
@class FBKVOController, SCGrowingButton, SCLensInfoPresenter, SCPreferences, UILabel, UIView;
...
@property(retain, nonatomic) SCLensInfoPresenter *lensInfoPresenter; // @synthesize lensInfoPresenter=_lensInfoPresenter;
