...
@property(readonly, nonatomic) long long minimumDiskSizeLimitWithoutEviction; // @synthesize minimumDiskSizeLimitWithoutEviction=_minimumDiskSizeLimitWithoutEviction;
...
- (void)downloadStatusForUUID:(id)arg1 queue:(id)arg2 resultHandler:(CDUnknownBlockType)arg3;
- (id)downloadWithEntity:(id)arg1 mediaScenePath:(CDStruct_bac8f6e9)arg2 performer:(id)arg3 resultHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)addSnap:(id)arg1 mediaURL:(id)arg2 mediaOverlayURL:(id)arg3;
...
- (void)addHDMediaForSnap:(id)arg1 HDMediaURL:(id)arg2 mediaOverlayURL:(id)arg3 isSynced:(_Bool)arg4 synchronous:(_Bool)arg5 queue:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (_Bool)addHDMediaForSnap:(id)arg1 HDMediaURL:(id)arg2 mediaOverlayURL:(id)arg3;
