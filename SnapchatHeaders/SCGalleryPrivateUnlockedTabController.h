...
+ (int)context;
@property(readonly, copy, nonatomic) NSArray *allGalleryEntries; // @synthesize allGalleryEntries=_allGalleryEntries;
@property(readonly, nonatomic) SCGalleryTabsConfiguration *configuration; // @synthesize configuration=_configuration;
