...
@class GPBStringBoolDictionary, GPBStringInt64Dictionary, NSMutableArray, NSMutableDictionary, NSString, SCPBHeader, SCPBIdentityMischiefMetadata, SCPBMessageBody;

@interface SCPBMischiefUpdateMessage : GPBMessage
{
}
...
@property(nonatomic) _Bool hasMischiefMetadataResult; // @dynamic hasMischiefMetadataResult;
...
@property(retain, nonatomic) SCPBIdentityMischiefMetadata *mischiefMetadataResult; // @dynamic mischiefMetadataResult;
@property(copy, nonatomic) NSString *mischiefUpdateMessageType; // @dynamic mischiefUpdateMessageType;
@property(nonatomic) long long mischiefVersion; // @dynamic mischiefVersion;
@property(copy, nonatomic) NSString *newMischiefName; // @dynamic newMischiefName;
@property(copy, nonatomic) NSString *originParticipantId; // @dynamic originParticipantId;
@property(retain, nonatomic) NSMutableArray *participantsIdsArray; // @dynamic participantsIdsArray;
@property(readonly, nonatomic) unsigned long long participantsIdsArray_Count; // @dynamic participantsIdsArray_Count;
