...
@class NSString, SCCheetahSendToRecipientDataProvider, SCSearchCollectionViewSectionUpdateModel, SCSearchEventListenerAnnouncer;
...
- (id)initWithDataProvider:(id)arg1 newUserTooltipEnabled:(_Bool)arg2;
