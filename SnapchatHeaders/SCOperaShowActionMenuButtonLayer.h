...
{
    _Bool _enableTeachingToolTips;
    _Bool _smallTapZone;
    SCOperaPage *_page;
}

+ (id)layerWithProperties:(id)arg1 page:(id)arg2;
@property(readonly, nonatomic) _Bool smallTapZone; // @synthesize smallTapZone=_smallTapZone;
@property(readonly, nonatomic) _Bool enableTeachingToolTips; // @synthesize enableTeachingToolTips=_enableTeachingToolTips;
