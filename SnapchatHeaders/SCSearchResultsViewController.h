...
@class NSDate, NSString, SCHovaOverscrollController, SCSearchContentViewControllerContext, SCSearchEventListenerAnnouncer, SCSearchNetworkLogger, SCSearchNoResultTracker, SCSearchQuery, SCSearchQueryReplayController, SCSearchQueryResultController, SCSearchSession, UIButton, UICollectionView, UILabel, UIView;
...
@property(retain, nonatomic) SCSearchEventListenerAnnouncer *eventAnnouncer; // @synthesize eventAnnouncer=_eventAnnouncer;
@property(retain, nonatomic) UIButton *trendingButton; // @synthesize trendingButton=_trendingButton;
...
- (_Bool)handleInAppNotificationIfNeeded:(id)arg1;
