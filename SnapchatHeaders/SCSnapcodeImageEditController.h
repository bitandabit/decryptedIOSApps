...
@interface SCSnapcodeImageEditController : GenericSettingsViewController <UIImagePickerControllerDelegate, SCWebImageScraperClientDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, UICollectionViewDataSource>
{
...
- (id)getPageViewName;
- (id)getTitle;
- (id)initWithPageViewName:(id)arg1 title:(id)arg2 leftSwipeEnabled:(_Bool)arg3 scannableInfo:(id)arg4 businessProfileHandler:(id)arg5 userSession:(id)arg6;
- (id)initWithPageViewName:(id)arg1 title:(id)arg2 leftSwipeEnabled:(_Bool)arg3 businessProfileHandler:(id)arg4 userSession:(id)arg5;
