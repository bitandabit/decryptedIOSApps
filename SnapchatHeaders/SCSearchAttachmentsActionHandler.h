...
@class NSString, SCSearchAttachmentsDataProvider, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, SCSearchSession;
...
- (_Bool)_presentPhoneOrSMSWithActionModel:(id)arg1;
