...
@class NSMutableArray, NSSet, NSString, SCArcadiaDataProvider, SCLens, SCLensDiscoverySearchResultsViewController, SCSearchView, SCUserSession, UIBarButtonItem, UIButton, UINavigationBar, UIView;
