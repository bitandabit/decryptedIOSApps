...
@property(copy) CDUnknownBlockType mapShotSelectionHandler; // @dynamic mapShotSelectionHandler;
@property(copy) CDUnknownBlockType assetSelectionHandler; // @dynamic assetSelectionHandler;
