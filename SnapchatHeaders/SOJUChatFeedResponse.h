...
@class NSArray, NSString, SOJUConversationsResponseInfo, SOJUFeedResponseInfo, SOJUFriendsResponse, SOJUMessagingGatewayInfo, SOJUServerInfoResponse, SOJUUpdatesResponse;
