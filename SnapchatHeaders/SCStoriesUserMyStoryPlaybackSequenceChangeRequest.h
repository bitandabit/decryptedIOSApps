...
@interface SCStoriesUserMyStoryPlaybackSequenceChangeRequest : NSObject <SCDocObjectChangeRequest>
{
    long long _rowid;
    int _requestType;
    NSString *_userId;
...
+ (id)deletionRequestForStoriesUserMyStoryPlaybackSequence:(id)arg1;
+ (id)changeRequestForStoriesUserMyStoryPlaybackSequence:(id)arg1;
+ (id)creationRequestWithStoriesUserMyStoryPlaybackSequence:(id)arg1;
...
- (id)_storiesUserMyStoryPlaybackSequence;
