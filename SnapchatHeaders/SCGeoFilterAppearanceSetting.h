...
@class NSArray, NSDictionary, NSNumber, NSString, SCSponsoredSlug, SOJUUnlockableTrackInfo;
...
- (id)initWithIsSponsored:(_Bool)arg1 isUpdatable:(_Bool)arg2 guaranteedDelivery:(_Bool)arg3 isBelowDrawingLayer:(_Bool)arg4 isAnimated:(_Bool)arg5 isFrameFilter:(_Bool)arg6 isActionmoji:(_Bool)arg7 isBitmoji:(_Bool)arg8 isFriendFilter:(_Bool)arg9 eligibleForNotification:(_Bool)arg10 autoStacking:(long long)arg11 unlockableContentType:(long long)arg12 unlockableCategory:(id)arg13 unlockableAttributes:(id)arg14 updateLabelPosition:(struct CGPoint)arg15 sponsoredSlug:(id)arg16 unlockableTrackInfo:(id)arg17 dynamicFilterRefreshHint:(id)arg18 dynamicFilterUpdatingMessage:(id)arg19 filterPrompt:(id)arg20 filterScore:(id)arg21 eligibility:(long long)arg22;
