...
@class NSString, NSURL, PreviewViewController, SCShazamOperaPresenter, SCShazamShareController, SCSongInfo, SCUserSession, UIButton, UIImage, UIImageView, UILabel, UIView;
