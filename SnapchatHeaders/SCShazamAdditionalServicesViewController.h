...
@interface SCShazamAdditionalServicesViewController : GenericSettingsViewController <UITableViewDataSource, UITableViewDelegate, SWTableViewCellDelegate, SCSWSongInfoCellDelegate>
{
