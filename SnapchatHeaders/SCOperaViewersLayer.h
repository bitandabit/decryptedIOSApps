...
@class NSArray, NSString, SCOperaPage, UIColor;
...
@property(nonatomic) _Bool enableCheetahUI; // @synthesize enableCheetahUI=_enableCheetahUI;
...
@property(readonly, nonatomic) id <SCOperaImageProvider> viewersLayerCollectionCellIconProvider; // @synthesize viewersLayerCollectionCellIconProvider=_viewersLayerCollectionCellIconProvider;
@property(readonly, copy, nonatomic) NSString *viewersLayerCollectionCellLoadingIconName; // @synthesize viewersLayerCollectionCellLoadingIconName=_viewersLayerCollectionCellLoadingIconName;
