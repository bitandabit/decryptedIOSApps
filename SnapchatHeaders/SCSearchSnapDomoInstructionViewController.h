...
@class NSString, SCHeader, SCSearchSnapDomoInstructionView;
...
@property(nonatomic) __weak id <SCSearchInstructionViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
