...
@class NSString, SCMessageChatTableViewCell, SCMessageChatViewModel, UITableViewCell;
...
- (void)didRequestStateUpdateForMessageCell:(SCMessageChatTableViewCell *)arg1;
@end
