...
@class CADisplayLink, CLLocationManager, EAGLContext, GLKView, MGLAnnotationContainerView, MGLCompassDirectionFormatter, MGLMapCamera, MGLMapViewProxyAccessibilityElement, MGLReachability, MGLScaleBar, MGLStyle, MGLUserLocation, MGLUserLocationAnnotationView, NSArray, NSDate, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURL, SCXOpenGLStyleLayer, UIButton, UIImageView, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIPinchGestureRecognizer, UIRotationGestureRecognizer, UITapGestureRecognizer;
...
@property(retain, nonatomic) MGLMapViewProxyAccessibilityElement *mapViewProxyAccessibilityElement; // @synthesize mapViewProxyAccessibilityElement=_mapViewProxyAccessibilityElement;
...
@property(retain, nonatomic) NSMutableArray *scaleBarConstraints; // @synthesize scaleBarConstraints=_scaleBarConstraints;
@property(retain, nonatomic) UIImageView *glSnapshotView; // @synthesize glSnapshotView=_glSnapshotView;
...
@property(retain, nonatomic) MGLScaleBar *scaleBar; // @synthesize scaleBar=_scaleBar;
...
- (vector_a9c0768e)shapeAnnotationTagsInRect:(struct CGRect)arg1;
- (vector_a9c0768e)annotationTagsInRect:(struct CGRect)arg1;
...
@property(nonatomic) _Bool showsHeading;
@property(nonatomic) _Bool allowsTilting;
@property(nonatomic) _Bool allowsRotating;
@property(nonatomic) _Bool allowsScrolling;
@property(nonatomic) _Bool allowsZooming;
@property(nonatomic) double longitude;
@property(nonatomic) double latitude;
- (void)setStyleURL__:(id)arg1;
- (id)styleURL__;
@property(nonatomic) __weak SCXOpenGLStyleLayer *legacyStyleLayer; // @dynamic legacyStyleLayer;
- (void)forceDisplayCustomStyleLayers;
- (void)setCustomStyleLayersNeedDisplay;
- (void)removeCustomStyleLayerWithIdentifier:(id)arg1;
- (void)insertCustomStyleLayerWithIdentifier:(id)arg1 preparationHandler:(CDUnknownBlockType)arg2 drawingHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4 belowStyleLayerWithIdentifier:(id)arg5;
