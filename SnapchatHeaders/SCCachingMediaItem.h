...
@class NSArray, NSDate, NSNumber, NSString, NSURL, SCCache, SCCachingImageGenerating, SCCachingMediaItemBuildRequestGroup, SCCachingMediaManager, SCMemoryCache;
...
- (void).cxx_destruct;
- (void)_writeToSCCacheWithDataImages:(id)arg1 sourceLevel:(long long)arg2 targetSize:(struct CGSize)arg3 saveToDisk:(_Bool)arg4;
- (void)_writeToDiskWithDataImages:(id)arg1 sourceLevel:(long long)arg2 targetSize:(struct CGSize)arg3 faultToMemory:(_Bool)arg4 saveToDisk:(_Bool)arg5;
- (id)entityKeyForSCCache:(long long)arg1 targetSize:(struct CGSize)arg2;
- (id)cachingEntityKey;
- (void)evict;
...
- (id)_buildImageGeneratingFromSourceItem:(id)arg1 preferDecode:(_Bool)arg2 requiredSourceLevel:(long long)arg3 requestOptions:(id)arg4 resultHandler:(CDUnknownBlockType)arg5;
- (id)buildImageGeneratingFromSourceItem:(id)arg1 requiredSourceLevel:(long long)arg2 requestOptions:(id)arg3 resultHandler:(CDUnknownBlockType)arg4;
...
- (id)initWithContentURL:(id)arg1 entity:(id)arg2 cachingMediaManager:(id)arg3 targetSize:(struct CGSize)arg4 maxSourceLevel:(long long)arg5 maxImageCount:(long long)arg6 imageFormat:(unsigned long long)arg7 encryption:(id)arg8 performer:(id)arg9 imageCache:(id)arg10 memoryCache:(id)arg11 logger:(id)arg12;
