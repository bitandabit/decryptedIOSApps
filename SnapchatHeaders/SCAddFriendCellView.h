...
@protocol SCAddFriendCellViewDelegate;
...
- (void)setFriend:(id)arg1 alreadyAdded:(_Bool)arg2 pendingSnapsCount:(unsigned long long)arg3 isSearched:(_Bool)arg4;
- (void)setFriend:(id)arg1 alreadyAdded:(_Bool)arg2 pendingSnapsCount:(unsigned long long)arg3;
- (void)setLabelFrames;
