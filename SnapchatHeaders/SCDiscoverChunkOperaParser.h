...
+ (id)pagesPropertiesForChunk:(id)arg1 needsToCreateBottomViewModel:(_Bool)arg2 isInPlaylistMode:(_Bool)arg3 userSession:(id)arg4 mediaManager:(id)arg5 streamingURLProvider:(id)arg6;
