...
@class NSString, SCContactBookMigrationLoadingView, SCRegisterPhoneV2ViewController, SCRequestAddressBookAccessView, SCUserSession;
...
- (void)viewDidLoad;
- (void)loadView;
- (id)initWithUserSession:(id)arg1 skipPhoneVerification:(_Bool)arg2 fromPXPrompt:(_Bool)arg3;
