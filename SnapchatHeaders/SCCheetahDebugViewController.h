...
@class NSData, NSString, SCSearchLoadingView, SCUserSession, UIView, UIWebView;
...
@property(nonatomic) __weak id <SCCheetahDebugViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
