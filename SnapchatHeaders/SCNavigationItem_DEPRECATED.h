...
@interface SCNavigationItem_DEPRECATED : NSObject <SCOverscrolling>
{
    ...
    NSString *_title;
    unsigned long long _rightBarButtonItemsDirection;
...
@property(nonatomic) unsigned long long rightBarButtonItemsDirection; // @synthesize rightBarButtonItemsDirection=_rightBarButtonItemsDirection;
