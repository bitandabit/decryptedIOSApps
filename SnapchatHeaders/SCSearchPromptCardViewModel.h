...
@class NSString, SCSearchActionButtonViewModel;

@interface SCSearchPromptCardViewModel : NSObject <NSCopying>
{
...
- (id)initWithDescriptionText:(id)arg1 actionButtonViewModel:(id)arg2 contentEdgeInsets:(struct UIEdgeInsets)arg3;
