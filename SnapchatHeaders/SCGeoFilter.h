...
@class NSArray, NSDate, NSDictionary, NSNumber, NSSet, NSString, NSURL, SCGeoFilterLoadingMetaData, SCSponsoredSlug, SOJUUnlockableTrackInfo, SOJUUnlockablesCarouselGroup;
...
- (void).cxx_destruct;
- (_Bool)canLoadIntoMemories:(id)arg1;
