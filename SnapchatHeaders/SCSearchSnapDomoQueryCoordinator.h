...
@class NSString, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, SCSearchQuery, SCSearchSession;

@interface SCSearchSnapDomoQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
    SCSearchSession *_searchSession;
    SCSearchEventListenerAnnouncer *_eventAnnouncer;
    _Bool _shouldFetchNewTasks;
    _Bool _isLoading;
...
- (void).cxx_destruct;
- (void)didReceiveTaskServerSubmitResponse;
- (void)didSubmitTaskWithIdentifier:(id)arg1;
