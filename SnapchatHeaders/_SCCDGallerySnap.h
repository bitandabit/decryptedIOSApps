...
- (void)setPrimitivePendingOptionalMediaSyncValue:(_Bool)arg1;
- (_Bool)primitivePendingOptionalMediaSyncValue;
@property _Bool pendingOptionalMediaSyncValue;
...
@property(retain, nonatomic) NSString *hdMediaRedirectURI; // @dynamic hdMediaRedirectURI;
...
@property(retain, nonatomic) NSNumber *pendingOptionalMediaSync; // @dynamic pendingOptionalMediaSync;
