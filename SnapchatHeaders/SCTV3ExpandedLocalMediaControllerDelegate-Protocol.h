...
@class SCTV3ELMShrunkMeasurements, SCTV3ExpandedLocalMediaController, SCTV3MediaView;
...
- (SCTV3MediaView *)localVideoViewForELMController:(SCTV3ExpandedLocalMediaController *)arg1;
@end
