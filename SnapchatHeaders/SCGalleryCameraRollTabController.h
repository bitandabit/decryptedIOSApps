...
@class NSArray, NSHashTable, NSMutableArray, NSString, PHCachingImageManager, SCGalleryCameraRollTabHeaderView, SCGalleryCollectionViewHelper, SCGalleryCollectionViewSelectionHelper, SCGalleryEmptyTabView, SCGalleryTabCollectionView, SCGalleryTabCollectionViewFlowLayout, SCGalleryTabsConfiguration, SCUserSession, UIView, UIViewController;
@protocol SCGalleryTabControllerDelegate;

@interface SCGalleryCameraRollTabController : NSObject <UICollectionViewDataSource, UICollectionViewDelegate, SCGalleryCollectionViewHelperDataSource, SCGalleryCollectionViewSelectionHelperDataSource, SCGalleryCollectionViewSelectionHelperDelegate, SCGalleryEmptyTabViewDelegate, SCTimeProfilable, SCGalleryTabController, SCGalleryPhotoLibraryFetcherListener>
{
...
- (void)didReceivePhotoPermissionAuthorizationCallback;
