...
@class NSString, SCSearchNavigationCoordinator, SCSearchQuery, SCSearchSession;

@interface SCProfileV3AddFriendsQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
...
- (id)_quickAddSectionDescriptorForQuery:(id)arg1;
- (id)_addedMeSectionDescriptorForQuery:(id)arg1;
