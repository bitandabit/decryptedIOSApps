...
- (id)initWithIdValue:(id)arg1 submission:(id)arg2 owner:(id)arg3 asset:(id)arg4 assets:(id)arg5 targeting:(id)arg6 schedule:(id)arg7 properties:(id)arg8 offer:(id)arg9 payment:(id)arg10 approval:(id)arg11 serving:(id)arg12 cancellation:(id)arg13 locale:(id)arg14 tosVersion:(id)arg15 country:(id)arg16 orgCountry:(id)arg17 lease:(id)arg18 userAgent:(id)arg19 mobilePayment:(id)arg20 preRenderingAssetsStructuredId:(id)arg21 templateId:(id)arg22 discountCode:(id)arg23 templateInstanceId:(id)arg24 autoApprovalResult:(id)arg25 productType:(id)arg26 previewRequestId:(id)arg27 paymentCollectedBeforeSubmission:(id)arg28 shouldAvoidOrgApiCalls:(id)arg29 orgCurrency:(id)arg30;
- (id)toJson;
- (id)toDictionary;
