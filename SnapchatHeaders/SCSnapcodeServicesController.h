...
@class NSString, SCPreviewTooltipBalloon, SCScannableInfo, SCSnapcodeDetailMixinView, SCSnapcodeDotAnimationView, SCSnapcodeImageContainerView, SCSnapcodeShareView, SCSnapcodeSquadController, SCSnapcodeSquadTabCardView, SCSnapcodeTabBar, SCSnapcodeWebTabCardView, SCUserSession, SCWebImageScraperClient, SVGDocumentView, SVGRenderer, UIButton, UIColor, UIImage, UIScrollView, UITableView, UIView;
