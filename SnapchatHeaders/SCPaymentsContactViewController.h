...
@class NSArray, NSMutableDictionary, NSString, SCFloatLabeledTextField, SCLoadingIndicatorView, SCPaymentsContactDetails, SCPaymentsPageLogger, SCUserSession, UIColor, UIFont, UILabel, UIVisualEffectView;
