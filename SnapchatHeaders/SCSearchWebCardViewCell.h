...
@class NSString, SCSearchActionModel, SCSearchEventListenerAnnouncer, SCSearchNetworkImageView, UIImageView, UILabel;
@protocol SCSearchActionHandling, SCSearchItemDownloading;

@interface SCSearchWebCardViewCell : SCSearchCollectionViewCell <SCSearchActionable, SCSearchEventAnnouncing, SCSearchEventListener>
{
