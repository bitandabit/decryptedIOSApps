...
@class NSString, SCMapSearchSession, SCSearchEventListenerAnnouncer, SCSearchNavigationCoordinator, SCSearchQuery, SCSearchQueryResult;
@protocol SCSearchQueryCoordinating><SCSearchEventAnnouncing;
