...
@class NSArray, NSDate, NSDictionary, NSString, SOJUIdentityMischiefMetadata, SOJUVideoChatParams, UIColor, UIFont;
...
- (NSArray *)participantsForAvatarsWithPrimaryParticipant:(NSString *)arg1;
...
- (_Bool)matchesAllParticipants:(NSArray *)arg1;
- (_Bool)matchesParticipants:(NSArray *)arg1;
...
- (UIColor *)colorForUsername:(NSString *)arg1;
