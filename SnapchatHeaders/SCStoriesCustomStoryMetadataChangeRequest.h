...
- (id)initWithRowid:(long long)arg1 publicationId:(id)arg2 type:(long long)arg3 mischiefId:(id)arg4 displayName:(id)arg5 subText:(id)arg6 metadataTimestamp:(double)arg7 creationInfo:(id)arg8 geoConfig:(id)arg9 participants:(id)arg10 posterIdsPermitted:(id)arg11 viewerIdsPermitted:(id)arg12;
