...
@interface SCChatSnapV2ImageProvider : NSObject <SCOperaGifProvider, SCOperaImageProvider>
{
    SCChat *_chat;
}

- (void).cxx_destruct;
- (void)_logSnapPlaybackFailureForKey:(id)arg1 withReason:(long long)arg2;
