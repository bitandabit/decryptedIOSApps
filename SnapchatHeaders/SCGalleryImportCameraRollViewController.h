...
@class NSArray, NSNumberFormatter, NSString, PHCachingImageManager, SCGalleryImportCameraRollAssetItemsFetcher, SCGalleryImportCameraRollAssetItemsImporter, SCGalleryImportCameraRollViewControllerConfiguration, SCGalleryRoundButton, SCProgressOverlayView, SCUserSession, UIActivityIndicatorView, UICollectionView, UILabel, UIView;
...
@interface SCGalleryImportCameraRollViewController : SCGalleryLeftSwipableViewController <UICollectionViewDataSource, UICollectionViewDelegate, SCGalleryImportCameraRollSectionHeaderDelegate, SCProgressOverlayViewDelegate, SCTimeProfilable>
{
    ...
    UILabel *_infoLabel;
    SCGalleryRoundButton *_importSnapsButton;
