...
@class EGODatabase, EGODatabaseStatement, GeoParser, NSArray, NSDateFormatter, NSDictionary, NSMutableDictionary, NSMutableSet, SCGallerySearchLocalizationHelper, SCGalleryTagClusterIndexer, SCGalleryTakenNearbySearch, SCUserSession;
...
- (void)fetchAllSnapIdToGeofilterIdMap:(CDUnknownBlockType)arg1;
...
- (id)searchWithGeofilterId:(id)arg1 includePrivate:(_Bool)arg2 queue:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
