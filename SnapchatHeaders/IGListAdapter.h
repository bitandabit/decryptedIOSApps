...
@class IGListAdapterProxy, IGListDisplayHandler, IGListSectionMap, IGListWorkingRangeHandler, NSMapTable, NSMutableSet, NSString, UICollectionView, UIView, UIViewController;
@protocol IGListAdapterDataSource, IGListAdapterDelegate, IGListUpdatingDelegate, UICollectionViewDelegate, UIScrollViewDelegate;
...
- (id)sectionMapUsingPreviousIfInUpdateBlock:(_Bool)arg1;
- (_Bool)itemCountIsZero;
- (void)updateBackgroundViewShouldHide:(_Bool)arg1;
