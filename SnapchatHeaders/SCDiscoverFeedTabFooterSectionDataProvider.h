...
@class NSArray, NSString, SCCheetahStoriesDataStore, SCSearchEventListenerAnnouncer;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCDiscoverFeedTabFooterSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchSectionDataProviding>
{
...
- (void)tearDown;
- (void)setUp;
- (id)initWithStoriesDataStore:(id)arg1;
