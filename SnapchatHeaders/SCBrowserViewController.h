...
@class NSMutableArray, NSMutableDictionary, NSSet, NSString, NSTimer, NSURL, NSURLRequest, SCBrowserLocationBarView, SCOperaWebView, SCSafeBrowsingWarningView, UIButton, UIView, UIWebView;
