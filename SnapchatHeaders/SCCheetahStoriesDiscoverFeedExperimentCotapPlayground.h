...
@class NSMutableArray, SCCheetahStoriesActionHandler, SCCheetahStoriesQueryCoordinator, SCSearchQueryResultController, SCUserSession, UICollectionView;

@interface SCCheetahStoriesDiscoverFeedExperimentCotapPlayground : NSObject <SCCheetahStoriesDiscoverFeedExperiment>
{
...
- (void).cxx_destruct;
- (void)_resetCotapHistory;
- (int)_orderOfCustomCotapHistoryForStoryDedupeFp:(unsigned long long)arg1;
- (void)_overrideTapHistoryWithCotapOrder;
