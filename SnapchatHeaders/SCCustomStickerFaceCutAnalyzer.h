...
@class NSMutableSet, SCAutoStickerLogger, SCPreferences, SCQueuePerformer, SCUserSession;
...
- (void)_stickersFromCameraAndMemoiresWithCompletion:(long long)arg1 scanCount:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
