...
@interface SCCapturerBufferedVideoWriter : NSObject
{
    ...
    struct __CVPixelBufferPool *_defaultPixelBufferPool;
    struct __CVPixelBufferPool *_nightPixelBufferPool;
    struct __CVPixelBufferPool *_lensesPixelBufferPool;
...
- (struct __CVPixelBufferPool *)_newPixelBufferPoolWithWidth:(unsigned long long)arg1 height:(unsigned long long)arg2;
- (struct __CVPixelBufferPool *)_pixelBufferPoolWithInputSize:(struct CGSize)arg1 croppedSize:(struct CGSize)arg2;
