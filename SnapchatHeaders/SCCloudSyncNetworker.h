...
- (id)networkResumeableDownloadRequestWithURL:(id)arg1 isSmallFile:(_Bool)arg2 additionalHTTPHeaders:(id)arg3 contexts:(id)arg4 trackingInfo:(id)arg5;
- (id)networkResumeableDownloadRequestWithEndpoint:(id)arg1 SOJURequest:(id)arg2 isSmallFile:(_Bool)arg3 additionalHTTPHeaders:(id)arg4 contexts:(id)arg5 trackingInfo:(id)arg6;
- (id)networkResumeableDownloadRequestWithData:(id)arg1 isSmallFile:(_Bool)arg2 contexts:(id)arg3 trackingInfo:(id)arg4;
