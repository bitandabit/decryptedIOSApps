...
@property(readonly, nonatomic) double bounceOffset; // @synthesize bounceOffset=_bounceOffset;
...
- (void)generateBounceVideoWithOffset:(double)arg1 completion:(CDUnknownBlockType)arg2;
