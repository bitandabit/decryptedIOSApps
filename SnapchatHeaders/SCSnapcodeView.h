...
@class Friend, SCPulsingView, SVGDocumentView, UIActivityIndicatorView, UIImageView;
...
- (void)_renderProfilePictureWithFriend:(id)arg1 contexts:(id)arg2 currentSession:(int)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (void)_renderProfileImages:(id)arg1 contexts:(id)arg2 currentSession:(int)arg3 completionBlock:(CDUnknownBlockType)arg4;
