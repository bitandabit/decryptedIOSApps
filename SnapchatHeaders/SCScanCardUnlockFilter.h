...
@class NSDictionary, NSString, SCGeoFilter, SCGeoFilterView, SCLens, SCScanCardButton, SCUserSession, UIActivityIndicatorView, UIImage, UIImageView, UILabel, UIView;
