...
@class FBKVOController, NSDictionary, NSMutableArray, NSNumber, NSString, NSTimer, SCOperaConfiguration, SCOperaEventListenerAnnouncer, SCOperaPage, SCOperaSharedResourceManager, SCStopwatch, UILongPressGestureRecognizer, UIScrollView, UIView;
