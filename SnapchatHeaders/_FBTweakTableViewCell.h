...
@class FBTweak, NSString, UIStepper, UISwitch, UITextField, UIView, _FBTweakCollectionViewController;
...
@property(nonatomic) __weak _FBTweakCollectionViewController *parentTweakCollectionViewController; // @synthesize parentTweakCollectionViewController=_parentTweakCollectionViewController;
