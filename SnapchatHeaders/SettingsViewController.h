...
@interface SettingsViewController : SCLeftSwipableViewController <SCHeaderDataSource, SCHeaderDelegate, SCPotentiallyEligibleFlowDelegate, UINavigationControllerDelegate, SCShareUsernameControllerDelegate, SCSettingHeaderPromptViewDelegate, UITableViewDataSource, UITableViewDelegate>
{
