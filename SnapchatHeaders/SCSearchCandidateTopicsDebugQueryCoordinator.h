...
@class NSString, SCSearchCandidateStoryTopicProvider, SCSearchNavigationCoordinator, SCSearchQuery;

@interface SCSearchCandidateTopicsDebugQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
    SCSearchCandidateStoryTopicProvider *_topicProvider;
    _Bool _isLoading;
...
- (id)initWithCandidateTopicProvider:(id)arg1;
