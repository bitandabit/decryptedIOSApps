...
@class AVPlayer, NSArray, NSMutableArray, NSString, SCCAEAGLView, SCImageProcessVideoPlaybackSession, SCPreviewBlob, SCStickerContainer, SCUserSession, UIImageView;
