...
- (id)initWithUsername:(id)arg1 userId:(id)arg2 storyThumbnail:(id)arg3 displayName:(id)arg4 friendmoji:(id)arg5 searchAddReason:(long long)arg6 bitmojiAvatarId:(id)arg7 bitmojiSelfieId:(id)arg8 isSnapchatter:(_Bool)arg9 isVerified:(_Bool)arg10 isPopular:(_Bool)arg11;
