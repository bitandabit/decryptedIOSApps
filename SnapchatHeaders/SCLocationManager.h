...
@class CLHeading, CLLocation, CLLocationManager, NSDictionary, NSHashTable, NSMutableArray, NSString, SCLocationManagerState, SCQueuePerformer, SCSpeed;
...
@interface SCLocationManager : NSObject <CLLocationManagerDelegate, FBTweakObserver, SCTimeProfilable>
{
    ...
    _Bool _disableActiveLocationMonitoring;
...
+ (id)sharedInstance;
@property(nonatomic) _Bool disableActiveLocationMonitoring; // @synthesize disableActiveLocationMonitoring=_disableActiveLocationMonitoring;
...
@property(copy) SCSpeed *speed; // @synthesize speed=_speed;
...
- (void)setActiveLocationMonitoringEnabled:(_Bool)arg1;
