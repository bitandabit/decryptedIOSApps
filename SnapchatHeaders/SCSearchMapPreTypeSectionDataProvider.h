...
@class NSString, SCSearchEventListenerAnnouncer, SCSearchMapGiveAccessCardDismissManager, SCUserSession;
...
@property(readonly, nonatomic) SCSearchMapGiveAccessCardDismissManager *dismissManager; // @synthesize dismissManager=_dismissManager;
