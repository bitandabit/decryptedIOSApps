...
- (void)initTitle;
- (void)initScrollView;
- (id)initWithFrame:(struct CGRect)arg1 countryCode:(id)arg2 delegate:(id)arg3 isPasswordReset:(_Bool)arg4 isPasswordResetLoggedIn:(_Bool)arg5 isInContactsView:(_Bool)arg6;
