...
@class NSString, SCSearchEventListenerAnnouncer, SCSearchImageDownloader;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCSearchWebAttachmentSectionDataProvider : NSObject <SCSearchSectionDataProviding>
{
