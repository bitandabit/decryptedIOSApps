...
@interface SCGroupStoryCreateOptionsViewController : GenericSettingsViewController <UITableViewDataSource, UITableViewDelegate, SCGroupStorySelectMembersViewControllerDelegate, SCSendViewControllerNavigationDelegate>
{
