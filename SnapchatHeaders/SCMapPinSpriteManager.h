...
@class MGLMapView, SCMapSpriteTextureAnimator, SCXRenderLayer, SCXSpriteClusterViewState;

@interface SCMapPinSpriteManager : NSObject
{
    SCXSpriteClusterViewState *_pinSpriteCluster;
    SCMapSpriteTextureAnimator *_currentTextureAnimator;
    MGLMapView *_mapView;
