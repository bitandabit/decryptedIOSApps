...
@class LSAComponentManager, NSArray, SCLookseryFilterFactory, SCManagedCaptureDevice, UIImage;
@protocol SCLensFrameRateCounterListener, SCManagedAudioDataSourceListener><SCManagedVideoDataSourceListener, SCManagedLensProcessorStateListener, SCManagedVideoARDataSource;
...
- (void)detectLensCategoryOnNextFrame:(struct CGPoint)arg1 videoOrientation:(long long)arg2 lenses:(NSArray *)arg3 completion:(void (^)(SCLensCategory *, long long))arg4;
- (void)setShouldProcessARFrames:(_Bool)arg1;
- (void)setLensesActive:(_Bool)arg1 videoOrientation:(long long)arg2 filterFactory:(SCLookseryFilterFactory *)arg3;
