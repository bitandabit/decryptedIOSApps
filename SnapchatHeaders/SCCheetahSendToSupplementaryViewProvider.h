...
@class NSDictionary, NSString, SCCheetahSendToHeaderViewModel;
@protocol SCSearchActionHandling, SCSearchCollectionViewSectionSupplementaryViewProviderDelegate;

@interface SCCheetahSendToSupplementaryViewProvider : NSObject <SCSearchCollectionViewSectionSupplementaryViewProviding, SCSearchCollectionViewSupplementaryViewModelsConfigurable, SCSearchActionable>
{
    SCCheetahSendToHeaderViewModel *_viewModel;
