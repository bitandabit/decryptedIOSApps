...
@class NSDate, NSString, SCChatMediaContent;
...
- (id)initWithConversationId:(id)arg1 messageId:(id)arg2 messageType:(long long)arg3 messageSender:(id)arg4 messageTimestamp:(id)arg5 media:(id)arg6 isLastMediaInMessage:(_Bool)arg7;
