...
@class NSArray, NSDictionary, NSSet, NSString, SCOperaUserInfoProvider, SCOperaViewModel, UIColor;
@protocol SCOperaActivelyDisplayMediaStrategy, SCOperaAudioStatusProvider, SCOperaContextMenuOverlayProvider, SCOperaCriticalModeOperator, SCOperaDeviceOrientationMonitor, SCOperaGLCommandsProvider, SCOperaGifProvider, SCOperaHtmlProvider, SCOperaImageProvider, SCOperaMetaStoryResponseProviding, SCOperaMetaStoryViewControllerProviding, SCOperaNetworkRadioStatusEstimationOperator, SCOperaRemoteVideoPreloadStrategy, SCOperaRemoteVideoPropertiesProvider, SCOperaSafeBrowsingChecker, SCOperaShakeToReportOperator, SCOperaSnapLabeling, SCOperaVideoAssetProvider, SCOperaViewLogger, SCOperaViewModelsManipulator, SCOperaWebViewFaviconProvider, SCOperaWebViewPKPassProvider, SCOperaWebViewURLInterceptor, SCSearchActionHandling, SCSearchEventListener, SCSearchItemDownloading;
...
@interface SCOperaConfiguration : NSObject
{
    ...
    _Bool _enableNewAdvanceAnimation;
...
@property(readonly, nonatomic) _Bool enableNewAdvanceAnimation; // @synthesize enableNewAdvanceAnimation=_enableNewAdvanceAnimation;
...
@property(retain, nonatomic) id <SCOperaMetaStoryResponseProviding> metaStoryResponseProvider; // @synthesize metaStoryResponseProvider=_metaStoryResponseProvider;
@property(retain, nonatomic) id <SCOperaMetaStoryViewControllerProviding> metaStoryVCProvider; // @synthesize metaStoryVCProvider=_metaStoryVCProvider;
@property(retain, nonatomic) id <SCOperaSnapLabeling> snapLabeler; // @synthesize snapLabeler=_snapLabeler;
@property(retain, nonatomic) id <SCSearchActionHandling> searchActionHandler; // @synthesize searchActionHandler=_searchActionHandler;
...
@property(retain, nonatomic) id <SCSearchEventListener> searchLoggerListener; // @synthesize searchLoggerListener=_searchLoggerListener;
...
@property(nonatomic) long long videoFastStartStrategy; // @synthesize videoFastStartStrategy=_videoFastStartStrategy;
...
@property(nonatomic) _Bool pillarBoxingEnabled; // @synthesize pillarBoxingEnabled=_pillarBoxingEnabled;
