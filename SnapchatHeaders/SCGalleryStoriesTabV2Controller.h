...
#import "SCGalleryLagunaTabHDSelectHelperDataSource-Protocol.h"
...
@interface SCGalleryStoriesTabV2Controller : NSObject <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, SCGalleryCollectionViewHelperDataSource, SCGalleryStoryCellDelegate, SCGalleryOperaPresenterDelegate, SCGalleryCollectionViewSelectionHelperDataSource, SCGalleryCollectionViewSelectionHelperDelegate, SCLagunaAppStatusListener, SCLagunaEventListener, SCGalleryLagunaTabHDSelectHelperDataSource, SCMergedGalleryDataSourceListener, SCGalleryCellActionMenuHelperDelegate, SCGalleryCellActionMenuHelperDataSource, SCGalleryEntryViewCellDelegate, SCGalleryLagunaTabHeaderViewDelegate, SCNetworkConnectivityListener, SCGalleryTabController>
{
    ...
    _Bool _collectionViewIsReloadingData;
    ...
    NSMutableDictionary *_entryPageMap;
    ...
    _Bool _debugSpecsOnboardingTab;
...
@property(nonatomic) _Bool debugSpecsOnboardingTab; // @synthesize debugSpecsOnboardingTab=_debugSpecsOnboardingTab;
...
- (_Bool)_shouldUpdateHDSelectableEntries;
- (void)_updateHDSelectableEntriesWithNewContentAvailable:(id)arg1;
- (_Bool)_isHDSelectableEntry:(id)arg1;
...
- (id)galleryCellActionMenuHelperTransferSession:(id)arg1 item:(id)arg2;
...
- (_Bool)storyCell:(id)arg1 isMostRecentHDEligibleEntry:(id)arg2;
- (void)storyCell:(id)arg1 handleLongPress:(id)arg2 entry:(id)arg3;
...
- (void)storyCell:(id)arg1 didTapShowAll:(id)arg2 page:(long long)arg3 reload:(_Bool)arg4;
- (void)storyCell:(id)arg1 didLongPress:(id)arg2 snap:(id)arg3 entry:(id)arg4 fromView:(id)arg5;
- (void)storyCell:(id)arg1 didSelectSnap:(id)arg2 entry:(id)arg3 snapCell:(id)arg4 fromView:(id)arg5;
- (void)_selectSnap:(id)arg1 forStoryCell:(id)arg2 entry:(id)arg3;
- (void)_toggleExpand:(id)arg1 cell:(id)arg2;
- (void)storyCell:(id)arg1 expandCell:(id)arg2;
- (_Bool)storyCell:(id)arg1 isEntryExpanded:(id)arg2;
...
- (void)_handleLongPress:(id)arg1 cell:(id)arg2 entry:(id)arg3 selectionMode:(unsigned long long)arg4;
...
- (Class)_cellClassForEntry:(id)arg1;
...
- (_Bool)_snapsUpdated:(id)arg1;
- (_Bool)_dataUpdated:(id)arg1;
