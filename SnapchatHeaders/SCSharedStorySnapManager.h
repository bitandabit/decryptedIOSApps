...
- (void)fetchSearchMediaForDynamicStoryId:(id)arg1 snapId:(id)arg2 metadataDownloadCompletion:(CDUnknownBlockType)arg3 storyDownloadCompletion:(CDUnknownBlockType)arg4 withRequestContexts:(id)arg5;
