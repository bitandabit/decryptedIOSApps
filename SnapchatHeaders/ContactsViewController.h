...
@class AddFriendsDelegateObject, EGORefreshTableHeaderView, Friend, NSArray, NSMutableArray, NSMutableOrderedSet, NSMutableSet, NSSet, NSString, SCIndexedTableView, SCSearchFriendsSubViewController, SCUserSession, UILabel, UIView;
