...
@class NSArray, NSString, SCExperimentManager, SCSearchEventListenerAnnouncer, SCSearchImageDownloader, SCSearchStoriesPresenter, SCUserSession;
...
- (void)_applyContainerCellViewModelsForIndexPath:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;
