...
@class NSString, SCShakeAttachmentViewProvider, SCShakeDescriptionViewProvider, SCShakeHeaderViewProvider, SCShakeProjectViewProvider, SCShakeSubmitViewProvider, UIImage;
...
- (void)setupHeaderView:(id)arg1 title:(id)arg2 isBetaShake:(_Bool)arg3;
