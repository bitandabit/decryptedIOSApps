...
@class SCFlipCameraButton, SCGrowingButton, SCNoHitClippingView, SCTDrawerHeightListenerAnnouncer, SCTV3ELMDraggingContext, SCTV3ELMGradientView, SCTV3MediaView, SCTV3MuteButton, UILongPressGestureRecognizer, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
@protocol SCTV3ChatServices, SCTV3ExpandedLocalMediaControllerDelegate, SCTV3LensesServices, SCTalkUIController;
...
- (id)initWithDelegate:(id)arg1 chatServices:(id)arg2 lensesServices:(id)arg3 talkUIContoller:(id)arg4 groupConversation:(_Bool)arg5;
