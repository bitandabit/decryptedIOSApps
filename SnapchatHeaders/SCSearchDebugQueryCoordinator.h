...
@class NSArray, NSString, SCSearchNavigationCoordinator, SCSearchQuery;

@interface SCSearchDebugQueryCoordinator : NSObject <SCSearchQueryCoordinating>
{
    NSArray *_debugQueryCoordinators;
    _Bool _isLoading;
