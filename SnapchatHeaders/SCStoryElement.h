...
@class NSString, SCAdInfo, SCAttributionInfo, SCStoryElementDebug, SCStoryElement_HtmlInfo, SCStoryElement_SnapInfo, SCStoryElement_WebMediaInfo, SCUserAction;
