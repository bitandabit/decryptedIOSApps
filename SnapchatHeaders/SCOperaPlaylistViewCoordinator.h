...
@class NSMutableDictionary, NSMutableSet, NSSet, NSString, SCExperimentManager, SCOperaConfiguration, SCOperaEventListenerAnnouncer, SCOperaPlaylist, SCOperaPlaylistItem, SCOperaPlaylistItemConverter, SCOperaViewController, SCOperaViewModel;
...
- (id)initWithItemGroupDataModels:(id)arg1 initialGroupDataModel:(id)arg2 mediaTypeConfigurations:(id)arg3 extraPropertiesProviders:(id)arg4 eventAnnouncer:(id)arg5 startWithAttachment:(_Bool)arg6 groupDisplaySquenceRule:(unsigned long long)arg7 experimentManager:(id)arg8;
