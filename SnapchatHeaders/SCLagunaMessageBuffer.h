...
@class NSMutableData;
@protocol SCLagunaMessageBufferDelegate;

@interface SCLagunaMessageBuffer : NSObject
{
    id <SCLagunaMessageBufferDelegate> _delegate;
...
@property(nonatomic) __weak id <SCLagunaMessageBufferDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
