...
@class NSString, SCCheetahSendToLogger, SCCheetahSendToRecipientDataProvider, SCSearchEventListenerAnnouncer, SCSendToSelectionStateManager, SCUserSession;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCCheetahSendToQuickAddSectionDataProvider : NSObject <SCSearchUpdateListener, SCSearchEventListener, SCSearchSectionDataProviding>
{
