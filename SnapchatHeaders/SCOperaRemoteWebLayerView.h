...
#import "SCOperaSafeBrowsingWarningViewDelegate-Protocol.h"
#import "SCOperaWebViewHeaderViewDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class FBShimmeringView, NSString, NSTimer, NSURL, SCConnectionErrorStateView, SCLoadingIndicatorView, SCOperaSafeBrowsingWarningView, SCOperaWebView, SCOperaWebViewHeaderView, SCWebViewProgressIndicator, UIButton, UIColor, UIImageView, UILabel, UILongPressGestureRecognizer, UISwipeGestureRecognizer, UITapGestureRecognizer;
...
- (void)removeAppInstallView;
- (void)dismissAppInstallViewAnimated:(_Bool)arg1;
- (void)showAppInstallView:(id)arg1;
