...
@class NSArray, NSString, SCCheetahPublisher;
...
@property(readonly, nonatomic) long long publisherTimestampMsecs; // @synthesize publisherTimestampMsecs=_publisherTimestampMsecs;
...
- (id)initWithPublisher:(id)arg1 editionId:(long long)arg2 headline:(id)arg3 iconURL:(id)arg4 publisherTimestampMsecs:(long long)arg5 isLive:(_Bool)arg6 snaps:(id)arg7;
