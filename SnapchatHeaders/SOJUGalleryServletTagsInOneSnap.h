...
- (id)initWithLocationTagList:(id)arg1 timeTagList:(id)arg2 metaTagList:(id)arg3 visualTagToConfidenceMap:(id)arg4 languageId:(id)arg5 tagCluster:(id)arg6 locationCluster:(id)arg7 caption:(id)arg8;
- (id)toJson;
- (id)toDictionary;
