...
@interface SCPhoneVerifyDeepLinkProcessor : NSObject <SCDeepLinkProcessor>
{
...
+ (_Bool)isValidDeepLinkCode:(id)arg1;
- (void).cxx_destruct;
- (long long)_determinePhoneVerifyDeepLinkPath:(id)arg1;
