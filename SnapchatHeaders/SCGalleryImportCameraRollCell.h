...
@class PHImageManager, SCGalleryImportCameraRollAssetItem, UIImageView, UILabel;
...
- (void)setImageManager:(id)arg1 assetItem:(id)arg2 thumbnailSize:(struct CGSize)arg3;
