...
@interface SCSnapAdsSubscribeAttachmentViewedEvent : SCSnapAdsBaseEvent
{
...
@property(nonatomic) _Bool channelIsSubscribedEndState; // @synthesize channelIsSubscribedEndState=_channelIsSubscribedEndState;
