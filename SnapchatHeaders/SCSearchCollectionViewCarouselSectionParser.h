...
@interface SCSearchCollectionViewCarouselSectionParser : NSObject <SCSearchQueryResultSectionParsing>
{
    _Bool _videoThumbnailEnabled;
...
- (id)initWithVideoThumbnailEnabled:(_Bool)arg1 streamingEnabled:(_Bool)arg2;
