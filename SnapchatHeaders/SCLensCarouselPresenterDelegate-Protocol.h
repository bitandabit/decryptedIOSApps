...
- (void)lensCarouselPresenter:(id <SCLensCarouselPresenterProtocol>)arg1 didScroll:(UIScrollView *)arg2 selectedCellDistance:(double)arg3;
...
- (void)lensCarouselPresenter:(id <SCLensCarouselPresenterProtocol>)arg1 didSelectLens:(SCLens *)arg2 index:(unsigned long long)arg3 totalLensesCount:(unsigned long long)arg4;
@end
