...
@class NSArray, NSString, SCSearchEventListenerAnnouncer, SCSearchSession;
@protocol NSCopying, SCPerforming, SCSearchSectionDataProvidingDelegate;

@interface SCSearchPublishersSectionDataProvider : NSObject <SCSearchSectionDataProviding>
{
