...
@class NSString, SCXRenderLayer, SCXSpriteViewState;

@interface SCMapSpriteTextureAnimator : NSObject
{
    NSString *_currentAnimationUUID;
    SCXSpriteViewState *_sprite;
...
@property(readonly, nonatomic) __weak SCXSpriteViewState *animationSprite; // @synthesize animationSprite=_animationSprite;
@property(readonly, nonatomic) __weak SCXSpriteViewState *sprite; // @synthesize sprite=_sprite;
- (void).cxx_destruct;
