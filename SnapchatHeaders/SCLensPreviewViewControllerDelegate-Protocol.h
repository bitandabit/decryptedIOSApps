...
- (void)lensPreviewViewController:(SCLensInPreviewViewController *)arg1 didSelectLens:(SCLens *)arg2 configuration:(SCLensConfiguration *)arg3 commandDelegate:(id <SCImageProcessLensCommandDelegate>)arg4;
@end
