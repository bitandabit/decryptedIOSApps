...
@class NSString, SCSearchImageDownloader, SCSearchRoundedCornerImageView, UILabel, UIView;
@protocol SCSearchActionHandling;

@interface SCSearchWebAttachmentCell : SCSearchCollectionViewCell <SCSearchActionable>
{
