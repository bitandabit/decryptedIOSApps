...
@property(readonly, nonatomic) UIImageView *staticWorldBackgroundImageView; // @synthesize staticWorldBackgroundImageView=_staticWorldBackgroundImageView;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool displaysStaticWorldBackground;
