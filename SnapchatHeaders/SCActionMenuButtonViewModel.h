...
- (void).cxx_destruct;
- (id)description;
- (id)initWithTitle:(id)arg1 accessibilityIdentifier:(id)arg2 image:(id)arg3 subtitleNames:(id)arg4 subtitleFormat:(id)arg5 handler:(CDUnknownBlockType)arg6;
- (id)initWithTitle:(id)arg1 image:(id)arg2 subtitleNames:(id)arg3 subtitleFormat:(id)arg4 handler:(CDUnknownBlockType)arg5;
