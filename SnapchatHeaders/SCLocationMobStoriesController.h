...
@interface SCLocationMobStoriesController : NSObject <SCLocationDataController, SCTimeProfilable>
{
    NSArray *_groupStoryAuths;
    id <SCLocationDataControllerDelegate> delegate;
}

+ (int)context;
+ (id)_identifiersFromMobStoryAuths:(id)arg1;
@property(nonatomic) __weak id <SCLocationDataControllerDelegate> delegate; // @synthesize delegate;
- (void).cxx_destruct;
- (_Bool)_shouldUpdateWithMobStoryAuths:(id)arg1;
- (void)clearCache;
