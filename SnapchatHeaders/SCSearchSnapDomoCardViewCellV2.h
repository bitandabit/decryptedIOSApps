...
@class NSString, SCSearchActionModel, SCSearchEventListenerAnnouncer, SCSearchNetworkImageView, UILabel, UIView, UIVisualEffectView;
@protocol SCSearchActionHandling, SCSearchItemDownloading;

@interface SCSearchSnapDomoCardViewCellV2 : SCSearchCollectionViewCell <SCSearchActionable, SCSearchThumbnailSizeProviding, SCSearchEventAnnouncing, SCSearchEventListener>
{
    ...
    long long _activeThumbnailCandidate;
