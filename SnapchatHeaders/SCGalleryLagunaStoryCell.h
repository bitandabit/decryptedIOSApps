...
@class NSArray, NSDate, NSString, SCGalleryLagunaProgressCircleLayer, SCGalleryLagunaStoryStatusObserver, SCLagunaDevice, SCLagunaTransferSession, SCPreviewTooltipBalloon;
...
@property(retain, nonatomic) SCLagunaTransferSession *transferSession; // @synthesize transferSession=_transferSession;
@property(retain, nonatomic) SCLagunaDevice *lagunaDevice; // @synthesize lagunaDevice=_lagunaDevice;
- (void).cxx_destruct;
...
- (void)setShowGetHDTooltip:(_Bool)arg1 animated:(_Bool)arg2;
- (_Bool)_shouldDisplayGetHdV3ToolTip;
