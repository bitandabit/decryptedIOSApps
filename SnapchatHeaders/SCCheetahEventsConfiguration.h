...
- (id)initWithUserSession:(id)arg1 rankingMinimumVisibleFraction:(float)arg2 rankingImpressionTimeInterval:(double)arg3 adsMinimumVisibleFraction:(float)arg4 adsImpressionTimeInterval:(double)arg5;
