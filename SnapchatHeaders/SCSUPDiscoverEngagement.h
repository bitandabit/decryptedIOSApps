...
@property(nonatomic) _Bool hasLegacyHide; // @dynamic hasLegacyHide;
@property(nonatomic) _Bool isChannelSubscribed; // @dynamic isChannelSubscribed;
@property(nonatomic) long long lastLegacyStateUpdateMsecs; // @dynamic lastLegacyStateUpdateMsecs;
...
@property(nonatomic) unsigned int totalLegacyHides; // @dynamic totalLegacyHides;
@property(nonatomic) unsigned int totalLegacyUnhides; // @dynamic totalLegacyUnhides;
