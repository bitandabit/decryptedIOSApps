...
@interface SCOnDemandGeofilterMyGeofiltersViewController : SCOnDemandGeofilterBaseLeftSwipableViewController <UITableViewDelegate, UITableViewDataSource, SCHeaderDelegate, SCHeaderDataSource, SCOnDemandGeofilterDataControllerListener, SCPullToRefreshViewDelegate>
{
    SCHeader *_header;
...
- (void)modifyRightButtonScale:(double)arg1 completion:(CDUnknownBlockType)arg2;
- (_Bool)_loadMyGeofiltersIfNeeded;
