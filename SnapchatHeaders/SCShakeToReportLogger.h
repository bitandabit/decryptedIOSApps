...
@interface SCShakeToReportLogger : NSObject
{
}
...
+ (void)logShakeErrorEvent:(id)arg1 message:(id)arg2 failStep:(long long)arg3 isV2:(_Bool)arg4;
+ (void)logShakeUploadEvent:(id)arg1 retryCout:(long long)arg2 totalFileSize:(long long)arg3 individualFileSize:(id)arg4 isV2:(_Bool)arg5;
+ (void)logShakeSendEvent:(id)arg1 retryCount:(long long)arg2 isV2:(_Bool)arg3;
