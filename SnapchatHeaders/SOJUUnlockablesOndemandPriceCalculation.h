...
- (id)initWithPricingRules:(id)arg1 amount:(id)arg2 mobilePaymentProductId:(id)arg3 taxAmount:(id)arg4 receiptTaxAmount:(id)arg5 quoteId:(id)arg6 discountCodeRef:(id)arg7;
- (id)toJson;
- (id)toDictionary;
