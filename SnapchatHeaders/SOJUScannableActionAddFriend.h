...
- (id)initWithUsername:(id)arg1 displayName:(id)arg2 userEmoji:(id)arg3 userId:(id)arg4 bitmojiAvatarId:(id)arg5 bitmojiSelfieId:(id)arg6 bitmojiSnapcodeSelfieId:(id)arg7;
- (id)toJson;
- (id)toDictionary;
