...
@class NSDictionary, NSMutableDictionary, NSNumber, NSString, SCCheetahFeedAst, SCSearchEventListenerAnnouncer;
@protocol SCPerforming;

@interface SCSendToRanker : NSObject <SCSearchEventAnnouncing>
{
