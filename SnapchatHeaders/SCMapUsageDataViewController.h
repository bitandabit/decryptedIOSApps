...
@class NSString, SCMapSettingsTableViewCell, SCUserSession, UISwitch, UITableView;

@interface SCMapUsageDataViewController : GenericSettingsViewController <SCLayoutAccessoryTableViewCellDelegate, UITableViewDataSource, UITableViewDelegate>
{
