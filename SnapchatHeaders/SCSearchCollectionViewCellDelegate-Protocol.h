...
@class SCSearchActionModel, SCSearchCollectionViewCell, UIView;

@protocol SCSearchCollectionViewCellDelegate <NSObject>
- (void)searchCollectionViewCell:(SCSearchCollectionViewCell *)arg1 didTriggerActionWithActionModel:(SCSearchActionModel *)arg2 fromSourceView:(UIView *)arg3;
