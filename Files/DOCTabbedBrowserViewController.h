...
@interface DOCTabbedBrowserViewController : DOCBaseDocumentBrowserViewController <UIDocumentBrowserViewControllerPrivateDelegate, UITabBarControllerDelegate, DOCSplitViewControllerDelegate, DOCFullDocumentManagerViewControllerDelegate>
{
    UIColor *_oldTint;
