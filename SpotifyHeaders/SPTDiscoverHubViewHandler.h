...
@interface SPTDiscoverHubViewHandler : NSObject <SPTHubViewHandler>
{
    id <SPTHubViewHandlerDelegate> _delegate;
    id <SPTBrowseRedirectButtonProvider> _browseRedirectButtonProvider;
}

+ (id)discoverTitleWithFieldReplacements:(id)arg1 fieldName:(id)arg2;
...
- (id)initWithBrowseRedirectButtonProvider:(id)arg1;
