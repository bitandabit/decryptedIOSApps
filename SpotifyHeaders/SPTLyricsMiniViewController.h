...
@class CAGradientLayer, GLUEGradientView, NSMutableSet, NSString, NSTimer, SPTImageBlurView, SPTLyricsFullScreenViewController, SPTLyricsLineSet, SPTLyricsLoggingService, SPTLyricsNowPlayingViewMissingSyncView, SPTLyricsNowPlayingViewOfflineView, SPTLyricsService, SPTLyricsTableFooterView, SPTPlayerTrack, SPTProgressView, UIButton, UIImageView, UILabel, UITableView, UIView;

@interface SPTLyricsMiniViewController : UIViewController <SPTPlayerObserver, UITableViewDataSource, UITableViewDelegate, SPTImageLoaderDelegate, SPTOfflineModeStateObserver, SPTKaraokeManagerObserver>
{
    _Bool _active;
    _Bool _visible;
    _Bool _showHint;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithTrack:(id)arg1 lyricsService:(id)arg2 player:(id)arg3 metaViewController:(id)arg4 loggingService:(id)arg5 imageLoader:(id)arg6 offlineModeState:(id)arg7 karaokeManager:(id)arg8;
