...
#import "SPTAssistedCurationCardModelDelegate.h"
#import "SPTAssistedCurationCardViewModel.h"

@class NSString;

@interface SPTAssistedCurationCardViewModelImplementation : NSObject <SPTAssistedCurationCardViewModel, SPTAssistedCurationCardModelDelegate>
{
...
@property(retain, nonatomic) id <SPTAssistedCurationCardModel> cardModel; // @synthesize cardModel=_cardModel;
...
- (id)initWithCardModel:(id)arg1 audioPreviewModel:(id)arg2;
