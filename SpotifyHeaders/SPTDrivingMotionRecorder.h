...
@interface SPTDrivingMotionRecorder : NSObject
{
    ...
    NSMutableArray *_gyroMeasurements;
}

@property(retain, nonatomic) NSMutableArray *gyroMeasurements; // @synthesize gyroMeasurements=_gyroMeasurements;
...
- (void)didReceiveGyroData:(id)arg1 error:(id)arg2;
