...
@class GLUENavigationCollectionViewCell, NSString, UIGestureRecognizer, UIView;

@interface EXP_HUGSNavigationRowComponentView : EXP_HUGSThemableComponentView <EXP_HUBComponentViewWithEvents, EXP_HUGSSelectableComponentView>
{
...
+ (id)styleForVariant:(long long)arg1 theme:(id)arg2;
