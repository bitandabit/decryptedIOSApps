...
@class NSString, SPTAllocationContext, SPTPodcastContextAwareURITypeManager, SPTPodcastDataLoaderShowEntityService, SPTPodcastHubLocalContentProvider, SPTPodcastHubViewHandler, SPTPodcastLogger, SPTPodcastOnboardingManager, SPTPodcastPreferences, SPTPodcastSearchHandler, SPTPodcastSortingService, SPTPodcastSpeedControlManagerImpl, SPTPodcastTestManagerImplementation;

@interface SPTPodcastFeatureImplementation : NSObject <SPTPodcastTestManagerObserver, SPTPodcastFeature>
{
...
@property(retain, nonatomic) SPTPodcastSearchHandler *searchHandler; // @synthesize searchHandler=_searchHandler;
