...
@class NSString, SPTAllocationContext, SPTDailyMixCollectionLibraryManager, SPTDailyMixLoggingService, SPTDailyMixManagerImplementation, SPTDailyMixUtils, SPTDailyMixViewUtils, SPTPersistentCache;
