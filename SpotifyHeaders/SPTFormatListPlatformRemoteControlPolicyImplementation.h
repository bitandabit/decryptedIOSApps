...
@property(nonatomic) NSArray *skipForwardCommandIntervals; // @synthesize skipForwardCommandIntervals=_skipForwardCommandIntervals;
...
@property(nonatomic) NSArray *skipBackwardCommandIntervals; // @synthesize skipBackwardCommandIntervals=_skipBackwardCommandIntervals;
