...
- (id)initWithSession:(id)arg1 logger:(id)arg2 playerEventListener:(id)arg3 audioCuePlayer:(id)arg4 suggestionGenerator:(id)arg5 entityDecorationController:(id)arg6;
