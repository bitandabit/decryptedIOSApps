...
#import "SPTRadioStationViewModel.h"
#import "SPTRadioStationsObserver.h"

@class NSArray, NSString, NSURL, SPTDailyMixViewUtils, SPTRadioPlaybackService, SPTRadioStation, SPTRadioStationsService;
...
- (_Bool)playTrackAtIndex:(long long)arg1 didUserTapTrackRow:(_Bool)arg2;
...
- (id)initWithStationURL:(id)arg1 productState:(id)arg2 playbackService:(id)arg3 stationsService:(id)arg4 offlineModeState:(id)arg5 dataLoader:(id)arg6 dailyMixViewUtils:(id)arg7 explicitContentAccessManager:(id)arg8;
