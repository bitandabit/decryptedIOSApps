...
- (struct UIViewController *)provideQueueViewControllerWithDelegate:(id)arg1 headUnitProvider:(id)arg2 navigationBarUnitProvider:(id)arg3 navigationBarButtonsUnitProvider:(id)arg4 queueInteractor:(id)arg5 entityDecorationController:(id)arg6;
- (void)unload;
- (void)load;
