...
#import "SPTNowPlayingCoverArtTapGestureRecognizerDelegate.h"
#import "SPTNowPlayingCoverArtViewDataSource.h"
#import "SPTNowPlayingCoverArtViewDelegate.h"
#import "UIGestureRecognizerDelegate.h"

@class AVAudioPlayer, NSString, SPTNowPlayingCarouselContentProviderRegistryImplementation, SPTNowPlayingCoverArtModel, SPTNowPlayingCoverArtTapGestureRecognizer, SPTNowPlayingCoverArtView, SPTNowPlayingLogger, SPTNowPlayingTestManager;

@interface SPTNowPlayingCoverArtController : NSObject <SPTNowPlayingCoverArtModelDelegate, SPTNowPlayingCoverArtViewDataSource, SPTNowPlayingCoverArtViewDelegate, SPTNowPlayingCarouselContentProviderRegistryImplementationDelegate, SPTImageLoaderDelegate, SPTNowPlayingCoverArtTapGestureRecognizerDelegate, UIGestureRecognizerDelegate>
{
    _Bool _visible;
    ...
    SPTNowPlayingCoverArtTapGestureRecognizer *_singleTapRecognizer;
    AVAudioPlayer *_highCowbellPlayer;
    AVAudioPlayer *_lowCowbellPlayer;
    id <SPTAdsManager> _adsManager;
}

@property(retain, nonatomic) id <SPTAdsManager> adsManager; // @synthesize adsManager=_adsManager;
@property(readonly, nonatomic) AVAudioPlayer *lowCowbellPlayer; // @synthesize lowCowbellPlayer=_lowCowbellPlayer;
@property(readonly, nonatomic) AVAudioPlayer *highCowbellPlayer; // @synthesize highCowbellPlayer=_highCowbellPlayer;
@property(readonly, nonatomic) SPTNowPlayingCoverArtTapGestureRecognizer *singleTapRecognizer; // @synthesize singleTapRecognizer=_singleTapRecognizer;
...
@property(nonatomic) __weak id <SPTCarouselBackgroundBlurDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)nowPlayingCoverArtTapGestureRecognizer:(id)arg1 didBeginTapWithNumberOfTouches:(unsigned long long)arg2;
- (void)recordTap:(id)arg1;
...
- (void)nowPlayingCoverArtView:(id)arg1 requiresImageForURL:(id)arg2 size:(struct CGSize)arg3;
...
- (id)nowPlayingCoverArtView:(id)arg1 contentForStagedContextCell:(id)arg2 cellSize:(struct CGSize)arg3;
- (id)nowPlayingCoverArtViewStagedContextImageURL:(id)arg1;
- (_Bool)nowPlayingCoverArtViewShouldDisplayStagedContext:(id)arg1;
...
- (void)coverArtViewDoubleFingerTapped:(id)arg1;
...
- (id)initWithModel:(id)arg1 delegate:(id)arg2 coverArtView:(id)arg3 imageLoaderFactory:(id)arg4 videoSurfaceManager:(id)arg5 carouselRegistry:(id)arg6 logger:(id)arg7 nowPlayingVideoManager:(id)arg8 testManager:(id)arg9 adsManager:(id)arg10;
