...
@interface SPTFreeTierMarketRestrictionsModel : NSObject
{
    ...
    NSURL *_marketingOptInContactUsURL;
}

@property(copy, nonatomic) NSURL *marketingOptInContactUsURL; // @synthesize marketingOptInContactUsURL=_marketingOptInContactUsURL;
