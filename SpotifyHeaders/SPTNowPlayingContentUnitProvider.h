...
@class NSHashTable, NSString, SPTCarouselBackgroundBlurController, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingTestManager, SPTPlayerState, SPTTheme, UIView;
...
- (id)initWithPlayer:(id)arg1 nowPlayingModel:(id)arg2 theme:(id)arg3 imageLoaderFactory:(id)arg4 videoSurfaceManager:(id)arg5 upsellManager:(id)arg6 nowPlayingVideoManager:(id)arg7 logger:(id)arg8 contentProviderRegistries:(id)arg9 testManager:(id)arg10 nowPlayingManager:(id)arg11 adsManager:(id)arg12;
