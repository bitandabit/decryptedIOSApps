...
{
    id <SPTFreeTierRecommenedPlaylistViewProvider> _recommenedPlaylistViewProvider;
    NSURL *_playlistURL;
...
@property(readonly, nonatomic) id <SPTFreeTierRecommenedPlaylistViewProvider> recommenedPlaylistViewProvider; // @synthesize recommenedPlaylistViewProvider=_recommenedPlaylistViewProvider;
- (void).cxx_destruct;
