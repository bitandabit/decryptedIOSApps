...
@property(readonly, nonatomic) id <SPTRunningTestManager> runningTestManager; // @synthesize runningTestManager=_runningTestManager;
...
- (id)initWithModel:(id)arg1 navigationBarModel:(id)arg2 nowPlayingManager:(id)arg3 theme:(id)arg4 logger:(id)arg5 queueLogger:(id)arg6 runningTestManager:(id)arg7 testManager:(id)arg8 player:(id)arg9 notificationCentre:(id)arg10 gaiaManager:(id)arg11 contextMenuFeature:(id)arg12 podcastContextMenuProvider:(id)arg13;
