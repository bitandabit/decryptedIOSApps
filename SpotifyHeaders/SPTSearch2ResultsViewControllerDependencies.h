...
@interface SPTSearch2ResultsViewControllerDependencies : NSObject
{
...
- (void).cxx_destruct;
- (id)initWithNetworkService:(id)arg1 sessionService:(id)arg2 glueService:(id)arg3 playlistPlatformService:(id)arg4 hubFrameworkService:(id)arg5 playerService:(id)arg6 containerService:(id)arg7 podcastService:(id)arg8 shelfService:(id)arg9 recentsDataSourceProvider:(id)arg10 onDemandService:(id)arg11;
- (id)init;
