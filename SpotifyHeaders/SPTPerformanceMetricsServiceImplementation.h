...
@class NSString, NSTimer, SPSession, SPTAllocationContext, SPTStartupTracer;

@interface SPTPerformanceMetricsServiceImplementation : NSObject <SPTNavigationManagerDelegate, SPTService, SPSessionObserver>
{
