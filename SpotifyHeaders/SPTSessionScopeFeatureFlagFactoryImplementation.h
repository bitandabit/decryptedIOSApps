...
#import "SPTFeatureFlagFactory.h"
...
- (id)initWithUserDefaults:(id)arg1 abbaFeatureFlags:(id)arg2 abbaExposureLogger:(id)arg3 productState:(id)arg4 localSettings:(id)arg5 logCenter:(id)arg6 featureSettingsItemFactory:(id)arg7;
