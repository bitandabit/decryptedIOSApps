...
@class NSArray, NSString, SPTStatusBarToken, SPTTabBarContainerLayout, SPTTheme, UIView, UIView<GLUETabBar>, UIViewController<SPTTabBarControllerProtocol><SPContentInsetViewController>;
