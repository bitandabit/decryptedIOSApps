...
@interface SPTCollectionPodcastViewModel : NSObject <SPTCollectionEntityList, SPTCollectionEntityViewModel>
{
    ...
    id <SPTCollectionPodcastDateCalculator> _dateCalculator;
}

@property(retain, nonatomic) id <SPTCollectionPodcastDateCalculator> dateCalculator; // @synthesize dateCalculator=_dateCalculator;
...
- (id)initWithDataLoader:(id)arg1 linkDispatcher:(id)arg2 podcastTestManager:(id)arg3 dateCalculator:(id)arg4;
