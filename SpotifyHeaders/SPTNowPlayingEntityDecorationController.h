...
- (id)initWithRadioManager:(id)arg1 runningLocalisationManager:(id)arg2 nowPlayingFeature:(id)arg3 runningTestManager:(id)arg4 playlistDataLoader:(id)arg5 collectionTestManager:(id)arg6;
