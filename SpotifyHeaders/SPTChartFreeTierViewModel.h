...
@interface SPTChartFreeTierViewModel : NSObject <SPTFreeTierAllSongsDataSource, SPTPlayerObserver, SPTOfflineModeStateObserver, SPTChartEntityDataSourceDelegate, SPTImageLoaderDelegate>
{
...
- (void)loadData;
- (void)dealloc;
- (id)initWithChartEntityDataSource:(id)arg1 offlineModeState:(id)arg2 allSongsRegistry:(id)arg3 linkDispatcher:(id)arg4 imageLoader:(id)arg5 player:(id)arg6 logger:(id)arg7;
