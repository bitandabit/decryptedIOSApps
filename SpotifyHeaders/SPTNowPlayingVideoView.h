...
- (void)hideAllViewsExceptAdChoiceView:(_Bool)arg1;
...
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1 theme:(id)arg2 videoSurface:(id)arg3 animationView:(id)arg4 adsManager:(id)arg5;
