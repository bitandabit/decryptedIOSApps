...
- (id)trackRowStyleWithMFT:(_Bool)arg1 subtitleStyleMetadata:(_Bool)arg2 transparentBackground:(_Bool)arg3;
- (id)calendarRowStyleWithSubtitleStyleMetadata:(_Bool)arg1 transparentBackground:(_Bool)arg2 shouldAddTrailingMargin:(_Bool)arg3;
...
- (id)contextMenuCellDefaultStyleWithIconColor:(id)arg1;
- (id)contextMenuCellDefaultStyle;
- (id)contextMenuCellDefaultStateDisabledStyle;
- (id)contextMenuCellDefaultStateHighlightedStyle;
- (id)contextMenuCellDefaultStateDefaultStyle;
- (id)navigationDisclosureIndicatorStyle;
- (id)navigationCellTitleAndSubtitleStyle;
