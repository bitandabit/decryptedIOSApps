...
@interface GLUENavigationRowUIStateStyle : NSObject <GLUEDebuggableStyle>
{
    ...
    double _labelMaxWidthRatio;
    GLUELabelStyle *_titleLabelStyle;
    double _titleBaselineFromBottom;
    GLUELabelStyle *_subtitleLabelStyle;
    double _subtitleBaselineFromTop;
}

@property(nonatomic) double subtitleBaselineFromTop; // @synthesize subtitleBaselineFromTop=_subtitleBaselineFromTop;
@property(copy, nonatomic) GLUELabelStyle *subtitleLabelStyle; // @synthesize subtitleLabelStyle=_subtitleLabelStyle;
@property(nonatomic) double titleBaselineFromBottom; // @synthesize titleBaselineFromBottom=_titleBaselineFromBottom;
@property(copy, nonatomic) GLUELabelStyle *titleLabelStyle; // @synthesize titleLabelStyle=_titleLabelStyle;
@property(nonatomic) double labelMaxWidthRatio; // @synthesize labelMaxWidthRatio=_labelMaxWidthRatio;
