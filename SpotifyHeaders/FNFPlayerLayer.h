...
@class CADisplayLink, EAGLContext, FNFGLDebugLogger, FNFRenderingThread, NSError, NSObject<OS_dispatch_queue>, NSString;
...
- (void)display:(struct __CVBuffer *)arg1 presentationTimeStamp:(CDStruct_1b6d18a9)arg2 iFrameEnqueued:(unsigned long long)arg3;
