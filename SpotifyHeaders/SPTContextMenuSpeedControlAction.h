...
- (id)image;
- (id)title;
- (id)initWithPodcastSpeedControlManager:(id)arg1 presentationService:(id)arg2 order:(long long)arg3 episodeURI:(id)arg4 logContext:(id)arg5 logCenter:(id)arg6;
