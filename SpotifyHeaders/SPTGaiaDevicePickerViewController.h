...
@interface SPTGaiaDevicePickerViewController : UIViewController <SPTGaiaDeviceStateManagerObserver, SPTGaiaOnboardingManagerObserver, SPTProductStateObserver, SPTAccountProductInformationObserver, UITableViewDelegate, SPTOfflineModeStateObserver, SPTPlayerObserver, SPTGaiaDevicePickerModelDelegate, SPTCastManagerObserver, SPTGaiaContextMenuViewControllerDelegate, SPTGaiaDevicePicker, UITableViewDataSource, SPTPageController>
{
    ...
    id <SPTGaiaDevicePickerFlagsProvider><SPTGaiaDevicePickerContextMenuFlagsProvider><SPTGaiaPickerEducationFlagsProvider> _flagsProvider;
...
@property(retain, nonatomic) id <SPTGaiaDevicePickerFlagsProvider><SPTGaiaDevicePickerContextMenuFlagsProvider><SPTGaiaPickerEducationFlagsProvider> flagsProvider; // @synthesize flagsProvider=_flagsProvider;
...
- (void)loadView;
- (void)dealloc;
- (id)initWithDeviceManager:(id)arg1 castDeviceManager:(id)arg2 onboardingManager:(id)arg3 volumeController:(id)arg4 setting:(id)arg5 productState:(id)arg6 productInformationController:(id)arg7 offlineMode:(id)arg8 player:(id)arg9 model:(id)arg10 flagsProvider:(id)arg11 devicePickerContext:(long long)arg12 contextMenuModelProvider:(id)arg13 savedDeviceManager:(id)arg14 settingsProvider:(id)arg15 notificationCenter:(id)arg16 educationModelManager:(id)arg17 modalPresentationController:(id)arg18 alertController:(id)arg19;
