...
@class NSString, SPTProfileLogger, SPTProfileViewModel, UITableView;

@interface SPTProfileDataSource : NSObject <SPTImageLoaderDelegate, SPTThemableViewLayoutDelegate, UITableViewDataSource, UITableViewDelegate>
{
...
- (void)dealloc;
- (id)initWithViewModel:(id)arg1 imageLoader:(id)arg2 linkDispatcher:(id)arg3 logger:(id)arg4;
