...
- (void)viewDidLoad;
- (id)initWithModel:(id)arg1 imageLoaderFactory:(id)arg2 theme:(id)arg3 logger:(id)arg4 videoSurfaceManager:(id)arg5 nowPlayingVideoManager:(id)arg6 testManager:(id)arg7 upsellManager:(id)arg8 adsManager:(id)arg9 carouselRegistry:(id)arg10;
