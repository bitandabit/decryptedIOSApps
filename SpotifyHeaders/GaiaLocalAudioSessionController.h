...
@class AVAudioPlayer, NSNotificationCenter, NSString, SPTAudioSessionActivator, SPTGaiaDeviceManager, SPTGaiaLogger;
...
- (void)remoteControlEventOfSubtypeOccured:(long long)arg1;
