...
@interface SPTRadioManager : NSObject <SPTRadioPlaybackObserver, SPTRadioStationsObserver, SPRadioManager>
{
...
- (void)fetchRadioStationWithSeedURL:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)fetchGenreRadioStations:(CDUnknownBlockType)arg1;
