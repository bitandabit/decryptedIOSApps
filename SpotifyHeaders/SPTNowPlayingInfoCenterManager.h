...
#import "SPTPlaybackQueueInitializer.h"

@class MPMediaItemArtwork, MPNowPlayingInfoCenter, NSHashTable, NSString, NSURL, SPTNowPlayingPlaybackController, SPTNowPlayingRemoteControlEventController, SPTNowPlayingTrackMetadataQueue, UIImage;
...
@property(readonly, nonatomic) SPTNowPlayingRemoteControlEventController *remoteControlEventController; // @synthesize remoteControlEventController=_remoteControlEventController;
...
- (id)placeholderImage;
- (void)dealloc;
- (id)initWithPlaybackController:(id)arg1 trackMetadataQueue:(id)arg2 remoteControlEventController:(id)arg3 gaiaDeviceStateManager:(id)arg4 localSettings:(id)arg5 infoCenter:(id)arg6 imageLoader:(id)arg7 lockScreenControlsStateProvider:(id)arg8 player:(id)arg9;
