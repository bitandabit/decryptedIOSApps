...
+ (id)fixedSpaceItem;
@property(nonatomic) _Bool updateWhenResumed; // @synthesize updateWhenResumed=_updateWhenResumed;
...
@property(retain, nonatomic) id <SPTFreeTierPlaylistViewModel> viewModel; // @synthesize viewModel=_viewModel;
@property(retain, nonatomic) UIViewController<SPTPageController> *viewController; // @synthesize viewController=_viewController;
...
- (id)initWithBarButtonItemManager:(id)arg1 collectionConfiguration:(id)arg2 contextMenuService:(id)arg3 alertController:(id)arg4 logger:(id)arg5;
