...
- (id)initWithCore:(id)arg1 actionRegistry:(id)arg2 linkDispatcher:(id)arg3 pushNotificationsLogger:(id)arg4 pushNotificationsBackendEnroller:(id)arg5 application:(id)arg6 containerUIService:(id)arg7;
