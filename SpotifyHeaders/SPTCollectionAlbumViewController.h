...
@class GLUEButton, NSString, NSURL, SPTCollectionEmptyEntityFooterView, SPTEntityTableHeaderView, SPTInfoView, SPTNetworkConnectivityController, SPTProgressView, SPTShareScreenshotObserverManager, SPTTableViewOfflineSwitchCell;

@interface SPTCollectionAlbumViewController : SPTableViewController <SPObjectRepresentation, SPTImageLoaderDelegate, SPTNavigationControllerNavigationBarState, SPTProductStateObserver, SPTOfflineSwitchDelegate, SPTBarButtonItemManagerObserver, SPTEntityHeaderBarButtonItemsProtocol, SPTShareScreenshotObserverManagerDataSource, SPTExplicitContentEnabledStateObserver, SPTCollectionAlbumModelDelegate, SPTPageController>
{
    _Bool _hasSetupContentOffset;
    _Bool _dataLoaded;
    _Bool _allowsScreenshots;
    id <SPTCollectionAlbumModel> _albumModel;
    CDUnknownBlockType _albumModelProvider;
...
@property(copy, nonatomic) CDUnknownBlockType albumModelProvider; // @synthesize albumModelProvider=_albumModelProvider;
...
- (void)viewDidLoad;
- (id)initWithAlbumModel:(id)arg1 albumModelProvider:(CDUnknownBlockType)arg2 productState:(id)arg3 shelves:(id)arg4 imageLoader:(id)arg5 networkConnectivityController:(id)arg6 collectionLogger:(id)arg7 collectionPlatform:(id)arg8 abbaFeatureFlags:(id)arg9 barButtonItemManager:(id)arg10 collectionTestManager:(id)arg11 shareFeature:(id)arg12 modalPresentationController:(id)arg13 spiderMenu:(id)arg14 explicitContentAccessManager:(id)arg15;
