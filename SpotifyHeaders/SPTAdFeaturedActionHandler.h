...
- (id)initWithCollectionPlatform:(id)arg1 dataloader:(id)arg2 adEventLogger:(id)arg3 player:(id)arg4 playlistModel:(id)arg5 followFactory:(id)arg6 adResolver:(id)arg7 linkDispatcher:(id)arg8;
