...
#import "SPTCollectionSongsModel.h"
#import "SPTOfflineModeStateObserver.h"
#import "SPTPlayerObserver.h"

@class NSArray, NSString, NSURL, SPTPlayOrigin;

@interface SPTCollectionSongsCosmosModel : NSObject <SPTPlayerObserver, SPTOfflineModeStateObserver, SPTCollectionSongItemPlaying, SPTCollectionSongsModel>
{
...
@property(retain, nonatomic) NSArray *sectionedSongItems; // @synthesize sectionedSongItems=_sectionedSongItems;
...
- (void)updateTracks;
- (void)load;
- (void)updateTracksWithResponse:(SPTCollectionPlatformDataLoaderResponse_f5c2288a *)arg1;
- (id)optionsForCurrentView;
