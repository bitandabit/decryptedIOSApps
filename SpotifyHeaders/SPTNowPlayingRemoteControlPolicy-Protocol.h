...
- (void)removeRemoteControlStateUpdateOserver:(id <SPTNowPlayingRemoteControlPolicyUpdateOserver>)arg1;
- (void)addRemoteControlStateUpdateOserver:(id <SPTNowPlayingRemoteControlPolicyUpdateOserver>)arg1;
