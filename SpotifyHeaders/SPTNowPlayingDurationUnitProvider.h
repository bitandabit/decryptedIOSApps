...
- (id)initWithPlayer:(id)arg1 theme:(id)arg2 trackPosition:(id)arg3 metadataQueue:(id)arg4 logger:(id)arg5 localSettings:(id)arg6 contentUnitProvider:(id)arg7 runningTestManager:(id)arg8 testManager:(id)arg9 nowPlayingManager:(id)arg10 animationView:(id)arg11;
