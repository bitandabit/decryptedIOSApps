...
@interface SPTLinkDispatcherImplementation : NSObject <SPTExternalLinkControllerCampaignDelegate, SPTURISchemeDispatcherMessagingDelegate, SPTExternalLinkController, SPTLinkDispatcher>
{
    ...
    id <SPTExternalLinkControllerSignupDelegate> _signupDelegate;
...
@property(readonly, nonatomic) UIApplication *externalLinkHandler; // @synthesize externalLinkHandler=_externalLinkHandler;
...
@property(nonatomic) __weak id <SPTExternalLinkControllerSignupDelegate> signupDelegate; // @synthesize signupDelegate=_signupDelegate;
- (void).cxx_destruct;
- (void)registerDefaultURISchemeHandlers;
- (id)buildHTTPLinkHandler;
- (id)buildSpotifyLinkHandlerWithURISubtypeRegistry:(id)arg1;
...
- (id)initWithCore:(id)arg1 alertController:(id)arg2 crashReporter:(id)arg3 URISubtypeRegistry:(id)arg4 externalLinkHandler:(id)arg5;
