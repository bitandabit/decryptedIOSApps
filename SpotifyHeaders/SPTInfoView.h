...
- (id)offlineModeExplanationForModelEntityVersion:(unsigned long long)arg1;
- (id)startTypingTextForModelEntityVersion:(unsigned long long)arg1 infoType:(unsigned long long)arg2;
- (id)startTypingTitleForModelEntityVersion:(unsigned long long)arg1 infoType:(unsigned long long)arg2;
- (void)configureForSearchInfoType:(unsigned long long)arg1 searchString:(id)arg2 offlineMode:(_Bool)arg3 useCompactMargins:(_Bool)arg4 modelEntityVersion:(unsigned long long)arg5;
