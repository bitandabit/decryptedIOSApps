...
@class NSString, SPTAllocationContext, SPTNowPlayingContentProviderRegistriesImplementation, SPTNowPlayingDeviceOrientationManager, SPTNowPlayingLogger, SPTNowPlayingManagerImplementation, SPTNowPlayingModel, SPTNowPlayingNavigationBarModel, SPTNowPlayingRemoteControlEventController, SPTNowPlayingStateProxy, SPTNowPlayingTestManager, SPTNowPlayingToggleViewController, SPTNowPlayingTrackMetadataQueue, SPTNowPlayingVideoManagerImplementation, SPTStatefulPlayer, UIViewController;
...
@property(nonatomic) __weak id <SPTCreatorFollowService> creatorFollowService; // @synthesize creatorFollowService=_creatorFollowService;
...
- (_Bool)isNowPlayingBarDevicesViewDisabled;
- (void)spotifyApplication:(id)arg1 setRemoteControlEnabled:(_Bool)arg2;
