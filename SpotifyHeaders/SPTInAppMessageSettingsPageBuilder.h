...
@class NSString, SPTDataLoader, SPTInAppMessageActionFactory, SPTInAppMessageQAToolPresentationController, SPTInAppMessageQAToolViewController, SPTInAppMessageQAToolViewModel;
...
@interface SPTInAppMessageSettingsPageBuilder : NSObject <SPTFeatureSettingsUIProvider>
{
    ...
    SPTInAppMessageQAToolPresentationController *_messagePresentationController;
...
@property(retain, nonatomic) SPTInAppMessageQAToolPresentationController *messagePresentationController; // @synthesize messagePresentationController=_messagePresentationController;
...
- (id)initWithFeatureSettingsItemFactory:(id)arg1 slateManager:(id)arg2 slateBuilderProvider:(id)arg3 actionFactory:(id)arg4 alertController:(id)arg5 qaToolDataLoader:(id)arg6 localSettings:(id)arg7;
