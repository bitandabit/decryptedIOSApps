...
- (id)logContext;
- (void)presentContextMenuForEpisode:(id)arg1 URI:(id)arg2 metadata:(id)arg3 sourceURL:(id)arg4 contextMenuDelegate:(id)arg5 inViewController:(id)arg6 senderView:(id)arg7 speedControlEnabled:(_Bool)arg8 options:(id)arg9;
...
- (id)initWithContextMenuFeature:(id)arg1 podcastTestManager:(id)arg2 collectionPlatfrom:(id)arg3 collectionTestManager:(id)arg4 podcastFeature:(id)arg5 presentationService:(id)arg6;
