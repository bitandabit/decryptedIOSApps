...
@interface SPTBuiltInSettingsFeatureImplementation : NSObject <SPTAbbaFeatureFlagsObserver, SPTFeatureFlagSignalObserver, SPTService>
{
...
- (id)provideLastFMSettingsWithSettingsViewController:(id)arg1;
...
- (id)provideLowBitrateOnCellularSettingsWithSettingsViewController:(id)arg1;
