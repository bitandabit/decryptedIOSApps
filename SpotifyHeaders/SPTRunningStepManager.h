...
@class CMAltimeter, CMMotionManager, NSDictionary, NSMapTable, NSMutableArray, NSOperationQueue, NSTimer, NSUUID, SPTCadence, SPTSignalEnergy, SPTStepManager, SPTZeroCrossing;
...
@property(retain) SPTStepManager *manager; // @synthesize manager=_manager;
...
@property(retain) id <SPTAccelerometerFilter> filter; // @synthesize filter=_filter;
...
- (void)currentCentredTempo:(float)arg1;
