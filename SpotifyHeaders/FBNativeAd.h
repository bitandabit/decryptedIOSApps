...
@class FBAdImage, FBAdPlacementDefinition, FBAdProvider, FBAdViewabilityValidator, FBDisplayAdController, FBNativeAdDataModel, FBNativeAdViewAttributes, NSDate, NSDictionary, NSHashTable, NSString, NSURL, UIView, UIViewController;
...
@property(readonly, copy, nonatomic) NSString *rawBody;
