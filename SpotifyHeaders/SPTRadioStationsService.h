...
- (void)ensureCreationOfStation:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (id)initWithDataLoader:(id)arg1 persistentCache:(id)arg2 dailyMixTestManager:(id)arg3;
