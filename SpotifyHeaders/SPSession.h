...
@interface SPSession : NSObject
{
    ...
    shared_ptr_90211097 _serverTime;
...
@property(nonatomic) NSString *clientVersionString; // @synthesize clientVersionString=_clientVersionString;
...
- (void)invalidate;
- (id)initWithCore:(id)arg1 coreCreateOptions:(id)arg2 isPerfTracingEnabled:(_Bool)arg3 core:(struct Core *)arg4 session:(struct Session *)arg5 accesspointHandler:(struct ApHandler *)arg6 serverTime:(shared_ptr_90211097)arg7 connectivityManager:(id)arg8 scheduler:(id)arg9 clientVersionString:(id)arg10 acceptLanguages:(CDUnknownBlockType)arg11;
...
@property(readonly, nonatomic) id <SPTSyncManager> syncManager;
