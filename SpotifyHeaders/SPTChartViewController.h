...
#import "SPTChartEntityDataSourceDelegate.h"
...
@class GLUEButton, NSString, NSURL, SPTChartLogger, SPTChartMetadataView, SPTChartViewModel, SPTEntityTableHeaderView, SPTInfoView, SPTNetworkConnectivityController, SPTProgressView, SPTTableView, SPTTableViewOfflineSwitchCell;

@interface SPTChartViewController : UIViewController <SPContentInsetViewController, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, SPTImageLoaderDelegate, SPTNavigationControllerNavigationBarState, SPTChartEntityDataSourceDelegate, SPTChartViewModelPlayerDelegate, SPViewController, SPTProductStateObserver, SPTOfflineSwitchDelegate, SPTFormatListPlatformManagerOfflineDelegate, SPTBarButtonItemManagerObserver, SPTEntityHeaderBarButtonItemsProtocol, SPTExplicitContentEnabledStateObserver, SPTPageController>
{
