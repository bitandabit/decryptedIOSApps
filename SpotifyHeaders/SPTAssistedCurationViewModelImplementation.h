...
- (id)initWithAssistedCurationModel:(id)arg1 addTrackHandler:(id)arg2 sortMechanism:(id)arg3 waitForCardProviders:(id)arg4 audioPreviewPlayer:(id)arg5 audioPreviewModelFactory:(id)arg6 educationPresenter:(id)arg7;
