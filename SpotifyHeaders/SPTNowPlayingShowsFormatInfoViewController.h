...
@class NSString, SPTNowPlayingContextMenuPresenter, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingShowsFormatInfoView, SPTNowPlayingTestManager, SPTTheme, UIViewController<SPTNowPlayingContainingViewController>;
...
@interface SPTNowPlayingShowsFormatInfoViewController : UIViewController <SPTNowPlayingAuxiliaryActionsModelObserver, SPTNowPlayingModelObserver, SPTNowPlayingContainerIdleMonitorObserver, SPTNowPlayingContainedViewController>
{
    ...
    SPTNowPlayingContextMenuPresenter *_contextMenuPresenter;
...
@property(retain, nonatomic) SPTNowPlayingContextMenuPresenter *contextMenuPresenter; // @synthesize contextMenuPresenter=_contextMenuPresenter;
...
- (void)loadView;
- (void)dealloc;
- (id)initWithModel:(id)arg1 theme:(id)arg2 contextMenuFeature:(id)arg3 podcastContextMenuProvider:(id)arg4 linkDispatcher:(id)arg5 logger:(id)arg6 testManager:(id)arg7 collectionTestManager:(id)arg8;
