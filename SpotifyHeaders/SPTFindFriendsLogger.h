...
- (void)logHitFollowButtonAtIndex:(unsigned long long)arg1 onTab:(unsigned long long)arg2 followState:(_Bool)arg3;
- (void)logNavigateToTab:(unsigned long long)arg1;
