...
#import "SPTInstrumentationInteractionMediatorProvider.h"
#import "SPTInstrumentationServiceMessagingHandler.h"
#import "SPTInstrumentationServicePrivate.h"

@class NSHashTable, NSString, SPTAllocationContext, SPTInstrumentationAppFocusStateMonitor, SPTInstrumentationInteractionItemIDGenerator, SPTInstrumentationInterfaceOrientationMonitor, SPTInstrumentationNavigationObserver, SPTInstrumentationPageStreamFactory, SPTInstrumentationPageStreamObserver, SPTInstrumentationStackedPageStream, SPTInstrumentationTransports;
...
@interface SPTInstrumentationServiceImplementation : NSObject <SPTInstrumentationServiceMessagingHandler, SPTAbbaFeatureFlagsObserver, SPTInstrumentationInteractionMediatorProvider, SPTInstrumentationServicePrivate>
{
    ...
    SPTInstrumentationInterfaceOrientationMonitor *_interfaceOrientationMonitor;
...
@property(retain, nonatomic) SPTInstrumentationInterfaceOrientationMonitor *interfaceOrientationMonitor; // @synthesize interfaceOrientationMonitor=_interfaceOrientationMonitor;
...
- (void)configureInterfaceOrientationMonitor;
