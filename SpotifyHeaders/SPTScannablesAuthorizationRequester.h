...
#import "SPTScannablesSlateFactoryDelegate.h"

@class NSObject<OS_dispatch_queue>, NSString, SPTScannablesDependencies, SPTScannablesOnboardingPresenterImplementation, SPTaskCompletionSource;
