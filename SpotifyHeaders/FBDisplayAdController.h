...
@class FBAdCandidate, FBAdEnvironmentData, FBAdPlacementDefinition, FBAdProvider, FBAdTimer, FBAdViewabilityValidator, FBDisplayAdAdapter, FBRewardedVideoRewardData, NSArray, NSString;
...
- (void)adapterDidComplete:(id)arg1;
