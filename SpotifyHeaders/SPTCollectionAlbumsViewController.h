...
@class GLUEEntityRowStyle, NSString, NSURL, SPTCollectionFilterBar, SPTCollectionFilterSearchBar, SPTInfoView, SPTNavigationManager, SPTProgressView, SPTViewLogger, UITableView;

@interface SPTCollectionAlbumsViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, SPObjectRepresentation, SPTCollectionFilterBarDelegate, SPTCollectionEntityListObserver, SPTBarButtonItemManagerObserver, SPTCollectionFilterSearchBarDelegate, SPContentInsetViewController, SPTPageController>
{
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithModel:(id)arg1 productState:(id)arg2 glueImageLoader:(id)arg3 collectionLogger:(id)arg4 NUXModifier:(id)arg5 barButtonItemManager:(id)arg6 collectionTestManager:(id)arg7 browseRedirectButtonProvider:(id)arg8 viewLogger:(id)arg9 navigationManager:(id)arg10 collectionTestManager:(id)arg11;
