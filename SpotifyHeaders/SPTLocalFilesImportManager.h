...
#import "SPTNUXModifying.h"
#import "SPTProductStateObserver.h"
#import "UIAlertViewDelegate.h"

@class NSDate, NSString, NSURL, SPTFilePickerViewController, SPTLocalFilesLogger;

@interface SPTLocalFilesImportManager : NSObject <SPTProductStateObserver, UIAlertViewDelegate, SPTNUXModifying>
{
    _Bool _enabled;
...
- (id)initWithProductState:(id)arg1 localSettings:(id)arg2 collectionPlatform:(id)arg3 collectionTestManager:(id)arg4 playlistModel:(id)arg5 imageLoaderFactory:(id)arg6 resolver:(id)arg7 metaViewController:(id)arg8 logCenter:(id)arg9;
