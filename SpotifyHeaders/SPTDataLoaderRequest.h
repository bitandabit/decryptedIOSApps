...
+ (id)spt_speechRecognitionRequestWithBoundary:(id)arg1 sampleRate:(id)arg2 utteranceId:(id)arg3 inputStream:(id)arg4 endpoint:(unsigned long long)arg5 shouldSaveAudio:(_Bool)arg6;
