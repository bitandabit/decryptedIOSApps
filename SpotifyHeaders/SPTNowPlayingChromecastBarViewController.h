...
@interface SPTNowPlayingChromecastBarViewController : UIViewController <SPTGaiaOnboardingManagerObserver, SPTGaiaDevicesAvailableViewDelegate, SPTNowPlayingContainedViewController>
{
...
- (id)initWithGaiaManager:(id)arg1 gaiaOnboardingManager:(id)arg2 nowPlayingManager:(id)arg3 theme:(id)arg4 devicesAvailableView:(id)arg5 logger:(id)arg6 player:(id)arg7;
