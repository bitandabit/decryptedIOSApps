...
@interface SPTNavigationConfigurationImplementation : NSObject <SPTNavigationConfiguration>
{
    ...
    NSSet *_tabBarFlagValuesMergingBrowseInSearch;
...
@property(retain, nonatomic) NSSet *tabBarFlagValuesMergingBrowseInSearch; // @synthesize tabBarFlagValuesMergingBrowseInSearch=_tabBarFlagValuesMergingBrowseInSearch;
...
- (_Bool)shouldMergeBrowseInSearch;
- (_Bool)isTabBarNowPlayingBarPrototypeEnabled;
- (_Bool)isFindEnabled;
- (_Bool)isBrowseInSearchEnabled;
