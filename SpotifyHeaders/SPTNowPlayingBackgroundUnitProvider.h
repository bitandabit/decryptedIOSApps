...
- (id)initWithPlayer:(id)arg1 model:(id)arg2 contentUnitProvider:(id)arg3 imageLoaderFactory:(id)arg4 theme:(id)arg5 logger:(id)arg6 videoSurfaceManager:(id)arg7 nowPlayingVideoManager:(id)arg8 testManager:(id)arg9 upsellManager:(id)arg10 nowPlayingManager:(id)arg11 adsManager:(id)arg12;
