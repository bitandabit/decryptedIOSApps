...
@class NSHashTable, NSString, NSURL, SPTNavigationManager, SPTNowPlayingBackgroundUnitProvider, SPTNowPlayingContainerIdleMonitor, SPTNowPlayingLogger, SPTNowPlayingModel, SPTNowPlayingTestManager, SPTNowPlayingTrackModulesViewController, SPTPlayerState, SPTStatusBarToken, SPTTheme, UIViewController<SPTQueueEnabling>;

@interface SPTNowPlayingToggleViewController : UIViewController <SPTNowPlayingContainerIdleMonitorObserver, SPTNowPlayingTrackModulesViewControllerDelegate, SPTNowPlayingUnitProviderObserver, SPTNowPlayingModelObserver, SPTNowPlayingModelDelegate, SPTPlayerObserver, SPTBarOverlayViewController, SPTPageController>
{
    _Bool _wasPlayingAd;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithModel:(id)arg1 playerViewController:(id)arg2 queueViewController:(id)arg3 trackModulesViewController:(id)arg4 theme:(id)arg5 player:(id)arg6 navigationManager:(id)arg7 backgroundUnitProvider:(id)arg8 testManager:(id)arg9 logger:(id)arg10 queueLogger:(id)arg11;
