...
- (void).cxx_destruct;
- (id)initWithURI:(id)arg1 title:(id)arg2 subtitle:(id)arg3 descriptionTitle:(id)arg4 imageURL:(id)arg5 mosaicImageURL:(id)arg6 backgroundVideoURL:(id)arg7 primaryColor:(id)arg8 items:(id)arg9 interruptions:(id)arg10;
