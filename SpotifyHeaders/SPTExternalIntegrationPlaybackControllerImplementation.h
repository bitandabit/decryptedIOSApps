...
@class NSSet, NSString, SPTExternalIntegrationPlatformLogger, SPTExternalIntegrationPlayQueueContentFactory, SPTObserverManager, SPTPlayerState;
...
@interface SPTExternalIntegrationPlaybackControllerImplementation : NSObject <SPTPlayerObserver, SPTExternalIntegrationPlaybackController>
{
    ...
    SPTExternalIntegrationPlatformLogger *_logger;
...
@property(readonly, nonatomic) SPTExternalIntegrationPlatformLogger *logger; // @synthesize logger=_logger;
...
- (void)playContentWithURI:(id)arg1 withOptions:(id)arg2 accessorySessionID:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)playContentWithURI:(id)arg1 withOptions:(id)arg2 origin:(id)arg3 accessorySessionID:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
