...
{
    _Bool _connectDevicesViewDisabled;
...
@property(nonatomic) _Bool connectDevicesViewDisabled; // @synthesize connectDevicesViewDisabled=_connectDevicesViewDisabled;
...
- (id)initWithPlayer:(id)arg1 gaiaManager:(id)arg2 model:(id)arg3 gaia:(id)arg4 logger:(id)arg5 upsellManager:(id)arg6 nowPlayingManager:(id)arg7 videoSurfaceManager:(id)arg8 theme:(id)arg9 devicesAvailableViewProvider:(id)arg10 barContentProviderRegistry:(id)arg11 shouldHideConnectDevices:(_Bool)arg12;
