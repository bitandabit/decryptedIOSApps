...
@class NSString, SPTAdContextManager, SPTAdFeatureFlagChecks, SPTAdFeaturedActionHandler, SPTAdFeedbackContextMenuHeaderHandler, SPTAdGlobalSettingsController, SPTAdNowPlayingManager, SPTAdRulesManager, SPTAdsViewModel;

@interface SPTAdsManagerImplementation : NSObject <SPTAdFeedbackContextMenuHeaderHandlerDelegate, SPTAdsManager, SPTNavigationManagerDelegate>
{
...
@property(readonly, nonatomic) _Bool shouldShowAdChoicesView;
...
- (void)addObservers;
- (void)dealloc;
- (id)initWithViewModel:(id)arg1 metaViewController:(id)arg2 adNowPlayingManager:(id)arg3 adFeaturedActionHandler:(id)arg4 adContextManager:(id)arg5 adRulesManager:(id)arg6 adFeatureChecker:(id)arg7 adSettingsController:(id)arg8 linkDispatcher:(id)arg9 contextMenuFeature:(id)arg10 adEventLogger:(id)arg11;
