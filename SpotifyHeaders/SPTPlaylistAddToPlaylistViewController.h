...
@class GLUEButtonStyle, NSArray, NSString, NSURL, SPSession, SPTPlaylistCreateNewPlaylistController, SPTPlaylistGLUETheme, SPTPlaylistLogger, SPTPlaylistTestManager, SPTPopoverController, SPTTableView;
