...
@class NSHashTable, NSObject<OS_dispatch_queue>, NSString, NSURL, SPTPlayerContext, SPTPlayerState, SPTPlayerSubscription;
...
- (id)playOrPrepareContext:(id)arg1 options:(id)arg2 origin:(id)arg3 prepare:(_Bool)arg4;
