...
@property(copy, nonatomic) NSURL *biographyExternalURL; // @synthesize biographyExternalURL=_biographyExternalURL;
...
- (id)biographyExternalURLsWithArray:(id)arg1;
