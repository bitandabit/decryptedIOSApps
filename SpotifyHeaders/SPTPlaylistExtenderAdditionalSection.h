...
@class NSArray, NSMutableArray, NSString, NSURL, SPTNetworkConnectivityController, SPTPlaylistExtender, SPTPlaylistExtenderLogger, SPTPlaylistExtenderRefreshViewCell, SPTPlaylistExtenderSectionHeaderView;

@interface SPTPlaylistExtenderAdditionalSection : NSObject <SPTPlayerObserver, SPTPlaylistExtenderSectionHeaderViewDelegate, SPTNetworkConnectivityControllerObserver, SPTPlaylistAdditionalSection, SPTPlaylistAdditionalSectionNux>
{
...
- (void)addToPlaylistAccessoryButtonTapped:(id)arg1;
...
- (void)setupTrackCell:(id)arg1 atIndex:(long long)arg2;
- (id)cellForIndex:(unsigned long long)arg1 forTableView:(id)arg2;
...
- (void)dealloc;
- (id)initWithPlaylistExtender:(id)arg1 player:(id)arg2 playlistURI:(id)arg3 playlistModel:(id)arg4 playlistDataLoader:(id)arg5 logger:(id)arg6 networkConnectivityController:(id)arg7 onExtraTracks:(CDUnknownBlockType)arg8;
