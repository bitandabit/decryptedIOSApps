...
#import "SPTContextMenuModelDelegate.h"
...
@class NSArray, NSNotificationCenter, NSString, NSURL, SPTContextMenuModel, SPTContextMenuSectionHeaderView, SPTContextMenuView, SPTTheme, UIView<SPTContextMenuHeader>;

@interface SPTContextMenuViewController : UIViewController <SPTContextMenuViewDataSource, SPTContextMenuViewDelegate, SPTImageLoaderDelegate, SPTContextMenuTaskActionDelegate, SPTPageController, SPTContextMenuModelDelegate, SPTSelfPresentingViewController>
{
    NSURL *_trackURL;
    id <SPTContextMenuViewControllerDelegate> _delegate;
    SPTContextMenuModel *_model;
    SPTTheme *_theme;
    ...
    SPTContextMenuSectionHeaderView *_sectionHeaderView;
}

@property(retain, nonatomic) SPTContextMenuSectionHeaderView *sectionHeaderView; // @synthesize sectionHeaderView=_sectionHeaderView;
...
@property(readonly, nonatomic) SPTContextMenuModel *model; // @synthesize model=_model;
...
- (void)contextMenuModelDidChangePlayerRestrictions:(id)arg1;
- (void)contextMenuModelDidChangePlayerOptions:(id)arg1;
...
- (void)loadView;
- (void)dealloc;
- (id)initWithHeaderImageURL:(id)arg1 tasks:(id)arg2 entityURL:(id)arg3 imageLoader:(id)arg4 headerView:(id)arg5 modalPresentationController:(id)arg6 model:(id)arg7 theme:(id)arg8 notificationCenter:(id)arg9;
...
- (id)initWithHeaderImageURL:(id)arg1 entityURL:(id)arg2 imageLoader:(id)arg3 headerView:(id)arg4 modalPresentationController:(id)arg5 model:(id)arg6 theme:(id)arg7 notificationCenter:(id)arg8;
- (id)initWithHeaderView:(id)arg1 actions:(id)arg2 entityURL:(id)arg3 imageLoader:(id)arg4 modalPresentationController:(id)arg5 model:(id)arg6 theme:(id)arg7 notificationCenter:(id)arg8;
