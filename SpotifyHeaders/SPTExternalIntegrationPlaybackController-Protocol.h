...
@class NSString, NSURL, SPTPlayOptions, SPTPlayOrigin, SPTPlayerOptionOverrides, SPTPlayerState;
...
- (void)playContentWithURI:(NSURL *)arg1 withOptions:(SPTPlayOptions *)arg2 accessorySessionID:(NSString *)arg3 completionHandler:(void (^)(NSError *))arg4;
- (void)playContentWithURI:(NSURL *)arg1 withOptions:(SPTPlayOptions *)arg2 origin:(SPTPlayOrigin *)arg3 accessorySessionID:(NSString *)arg4 completionHandler:(void (^)(NSError *))arg5;
