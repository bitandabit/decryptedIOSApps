...
@interface SPTEntityTableHeaderView : UIView <UIScrollViewDelegate, SPTThemableView, SPTThemableViewLayoutDelegate>
{
    ...
    _Bool _backgroundImageBlurringEnabled;
...
@property(nonatomic, getter=isBackgroundImageBlurringEnabled) _Bool backgroundImageBlurringEnabled; // @synthesize backgroundImageBlurringEnabled=_backgroundImageBlurringEnabled;
...
@property(nonatomic) _Bool showBannerView; // @synthesize showBannerView=_showBannerView;
...
- (void)updateRightBarButtonItemsFrames;
...
- (struct CGRect)frameForBannerView;
...
- (void)validateRightBarButtonItems:(id)arg1;
- (id)accessoryButtonForStickyHeader;
- (id)actionButtonForStickyHeader;
- (void)enablePageScrolling:(_Bool)arg1;
- (unsigned long long)numberOfPagesForScrollView;
- (void)displayBannerView:(_Bool)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;
- (id)createNavigationItemstickyHeaderTitleLabelView;
@property(readonly, nonatomic) UIFont *metadataLabelFont;
@property(readonly, nonatomic) UIImageView *imageBlurView;
