...
#import "SPTFreeTierYourLikesTrackViewModel.h"

@class NSString, NSURL, UIColor;

@interface SPTFreeTierYourLikesTrackViewModelImplementation : NSObject <SPTFreeTierYourLikesTrackViewModel>
{
    _Bool _playable;
...
- (id)initWithTrackEntity:(id)arg1 contextMenuPresenterFactory:(id)arg2 contextMenuOptionsFactory:(id)arg3 audioPreviewModel:(id)arg4 theme:(id)arg5;
