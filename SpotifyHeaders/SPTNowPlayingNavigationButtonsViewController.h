...
- (void)loadView;
- (void)dealloc;
- (id)initWithModel:(id)arg1 navigationBarModel:(id)arg2 nowPlayingManager:(id)arg3 theme:(id)arg4 logger:(id)arg5 queueLogger:(id)arg6 runningTestManager:(id)arg7;
