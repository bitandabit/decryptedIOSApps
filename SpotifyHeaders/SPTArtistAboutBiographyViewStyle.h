...
@interface SPTArtistAboutBiographyViewStyle : NSObject <GLUEStyle>
{
    ...
    GLUELabelStyle *_biographyExternalLinkLabelStyle;
    struct CGSize _biographyAuthorImageSize;
}

@property(copy, nonatomic) GLUELabelStyle *biographyExternalLinkLabelStyle; // @synthesize biographyExternalLinkLabelStyle=_biographyExternalLinkLabelStyle;
