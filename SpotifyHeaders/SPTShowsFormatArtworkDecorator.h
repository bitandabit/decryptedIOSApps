...
{
    id <SPTNowPlayingInfoCenterManagerProtocol> _infoCenterManager;
...
@property(readonly, nonatomic) id <SPTNowPlayingInfoCenterManagerProtocol> infoCenterManager; // @synthesize infoCenterManager=_infoCenterManager;
- (void).cxx_destruct;
- (id)decoratedArtwork:(id)arg1 forTrack:(id)arg2 state:(id)arg3;
- (_Bool)shouldDecorateArtworkForTrack:(id)arg1 state:(id)arg2;
- (void)dealloc;
- (id)initWithInfoCenter:(id)arg1 imageGenerator:(id)arg2;
