...
@class GLUEButton, GLUEEntityRowStyle, NSString, NSURL, SPSession, SPTCollectionFilterBar, SPTInfoView, SPTPlaylistCreateNewPlaylistController, SPTPlaylistGLUETheme, SPTSyncProgressView, SPTTableView, UIBarButtonItem, UITableView, UIView;

@interface SPTPlaylistFolderViewController : UIViewController <SPContentInsetViewController, SPTCollectionFilterBarDelegate, SPTSwipeableTableViewCellDelegate, SPTOfflineModeStateObserver, SPSessionObserver, SPTNavigationControllerNavigationBarState, SPTCollectionPromoting, UITableViewDelegate, UITableViewDataSource, SPTPlaylistFolderViewModelDelegate, SPTPlaylistCreateNewPlaylistControllerDelegate, SPTPlaylistRootFolderViewController, SPTPageController>
{
