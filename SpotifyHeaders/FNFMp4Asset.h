...
- (id)initWithURL:(id)arg1 moovAtomSize:(unsigned long long)arg2 moovAtomSizeForReattempt:(unsigned long long)arg3 bitrate:(unsigned long long)arg4 fetchBufferSizeInSeconds:(double)arg5 unstallBufferSizeInSeconds:(double)arg6 stallBufferSizeInSeconds:(double)arg7 firstFetchSizeInSeconds:(double)arg8 fetchBufferMultiplier:(double)arg9 unstallBufferMultiplier:(double)arg10 async:(_Bool)arg11;
- (id)initWithURL:(id)arg1 moovAtomSize:(unsigned long long)arg2 bitrate:(unsigned long long)arg3;
- (id)initWithURL:(id)arg1 moovAtomSize:(unsigned long long)arg2 moovAtomSizeForReattempt:(unsigned long long)arg3 bitrate:(unsigned long long)arg4 fetchBufferSizeInSeconds:(double)arg5 unstallBufferSizeInSeconds:(double)arg6 stallBufferSizeInSeconds:(double)arg7 firstFetchSizeInSeconds:(double)arg8 fetchBufferMultiplier:(double)arg9 unstallBufferMultiplier:(double)arg10;
