...
@interface SPTExternalIntegrationHubOneContentProviderService : NSObject <SPTService, SPTExternalIntegrationContentProvider>
{
    ...
    id <SPTHubExternalDataLoaderFactory> _homeDataLoaderFactory;
...
@property(readonly, nonatomic) id <SPTHubExternalDataLoaderFactory> homeDataLoaderFactory; // @synthesize homeDataLoaderFactory=_homeDataLoaderFactory;
