...
@class MultipleFollowModel, NSArray, NSString, SPTDataLoader;
...
- (void)requestData;
- (unsigned long long)featuredProfilesNotYetFollowedCount;
- (void)dealloc;
- (id)initWithDataLoader:(id)arg1 offlineModeState:(id)arg2 followFeature:(id)arg3;
