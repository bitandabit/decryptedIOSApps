...
@interface SPTShowsFormatEntityViewDataSource : NSObject <SPTImageLoaderDelegate, UICollectionViewDataSource>
{
    ...
    id <SPTSpiderGestureRegistry> _spiderMenuRegistry;
    id <GLUEImageLoader> _glueImageLoader;
}

+ (void)registerClassesForReuseWithCollectionView:(id)arg1;
@property(readonly, nonatomic) id <GLUEImageLoader> glueImageLoader; // @synthesize glueImageLoader=_glueImageLoader;
@property(nonatomic) __weak id <SPTSpiderGestureRegistry> spiderMenuRegistry; // @synthesize spiderMenuRegistry=_spiderMenuRegistry;
...
- (void)registerCellForSpiderMenu:(id)arg1 atIndexPath:(id)arg2 forCollectionView:(id)arg3;
...
- (id)initWithViewModel:(id)arg1 imageLoader:(id)arg2 logger:(id)arg3 linkDispatcher:(id)arg4 spiderMenuRegistry:(id)arg5 glueImageLoader:(id)arg6;
