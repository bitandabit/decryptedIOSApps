...
@class GLUEButtonStyle, GLUEGradientStyle, GLUEHeaderBackgroundStyle, GLUELabelStyle, NSString;
...
@interface SPTFreeTierCollectionHeaderContentViewStyle : NSObject <GLUEStyle>
{
    ...
    GLUEButtonStyle *_createPlaylistButtonStyle;
...
@property(copy, nonatomic) GLUEButtonStyle *createPlaylistButtonStyle; // @synthesize createPlaylistButtonStyle=_createPlaylistButtonStyle;
