...
@property(nonatomic) __weak id <SPTAlbumTestManager> albumTestManager; // @synthesize albumTestManager=_albumTestManager;
...
- (id)artistNames;
- (_Bool)shouldUpsellAndPlay;
- (_Bool)shouldOnlyUpsell;
...
- (_Bool)shouldShowWindowedTracksAsPremiumAtIndexPath:(id)arg1;
...
- (void)dealloc;
- (id)initWithPlayer:(id)arg1 offlineState:(id)arg2 offlineManager:(id)arg3 playbackStateRestorer:(id)arg4 dataLoader:(id)arg5 serviceName:(id)arg6 endpointPath:(id)arg7 albumURL:(id)arg8 clientSettings:(id)arg9 username:(id)arg10 collectionPlatform:(id)arg11 productState:(id)arg12 upsellManager:(id)arg13 collectionTestManager:(id)arg14 albumTestManager:(id)arg15 contributingArtistsService:(id)arg16 presentationService:(id)arg17 explicitContentAccessManager:(id)arg18;
- (id)trackURLs;
- (id)offlineURL;
