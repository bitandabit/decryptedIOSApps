...
- (void)startListening;
- (id)initWithSession:(id)arg1 options:(id)arg2 suggestionGenerator:(id)arg3 audioCuePlayer:(id)arg4 logger:(id)arg5 localSettings:(id)arg6;
