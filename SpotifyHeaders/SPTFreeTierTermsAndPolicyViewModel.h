...
- (id)termsUrlForLinkIndex:(long long)arg1;
- (id)termsAndConditionsAttributedText;
- (id)initWithUserInfoModel:(id)arg1 termsAndPolicyManager:(id)arg2 theme:(id)arg3 linkDispatcher:(id)arg4 adjustTracker:(id)arg5;
