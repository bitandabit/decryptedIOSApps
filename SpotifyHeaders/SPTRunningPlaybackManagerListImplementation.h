...
@class NSArray, NSDictionary, NSMapTable, NSString, NSTimer, NSURL, SPTDataLoader, SPTPlayOptions, SPTPlayerContext, SPTPlayerRestrictions, SPTPlayerState, SPTRunningAudioUXManager, SPTRunningImageCache, SPTRunningLocalisationManagerImplementation, SPTRunningPlaybackStateRestorer, SPTRunningStepManager;
