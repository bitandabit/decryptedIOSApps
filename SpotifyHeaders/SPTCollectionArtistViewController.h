...
@interface SPTCollectionArtistViewController : SPTableViewController <SPTImageLoaderDelegate, SPTNavigationControllerNavigationBarState, SPTEntityTableHeaderViewNavigationBarProvider, SPTProductStateObserver, SPTOfflineSwitchDelegate, SPTBarButtonItemManagerObserver, SPTEntityHeaderBarButtonItemsProtocol, SPTExplicitContentEnabledStateObserver, SPTCollectionArtistModelDelegate, SPTPageController>
{
