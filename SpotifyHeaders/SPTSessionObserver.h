...
@class NSString, SPCore, SPSession, SPTIncognitoModeHandler, SPTLogCenter, SPTNetworkConnectivityController;
...
- (void)dealloc;
- (id)initWithCore:(id)arg1 session:(id)arg2 incognitoModeHandler:(id)arg3 withLogCenter:(id)arg4 networkConnectivityController:(id)arg5;
