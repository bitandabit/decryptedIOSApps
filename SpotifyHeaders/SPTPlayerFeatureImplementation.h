...
@class NSString, SPTAllocationContext, SPTAudioSessionControllerImpl, SPTCastManager, SPTGaiaDeviceManager, SPTPlaybackErrorPicker, SPTPlaybackStateRestorer, SPTPlaybackStateStoreController, SPTPlaybackStateTimer, SPTPlayerSubscription;
...
@property(readonly, nonatomic) SPTCastManager *castDeviceManager; // @synthesize castDeviceManager=_castDeviceManager;
