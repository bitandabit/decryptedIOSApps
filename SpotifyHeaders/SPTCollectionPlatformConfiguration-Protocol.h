...
@class GLUEButton, NSString, NSURL, SPTSwipeableTableViewCellShelf, UIBarButtonItem, UIColor, UIImage;
...
- (UIImage *)overlayImageForTabBarAddedToCollectionSelected:(_Bool)arg1 size:(struct CGSize)arg2 image:(UIImage *)arg3;
...
- (NSString *)voiceConfirmationAfterSuccessfulActionForTrackWithCollectionState:(_Bool)arg1;
- (NSString *)actionAccessibilityHintWithCollectionState:(_Bool)arg1;
- (NSString *)actionNameForTrackWithCollectionState:(_Bool)arg1;
- (NSString *)actionNameForItemWithCollectionState:(_Bool)arg1;
