...
@property(nonatomic) NSString *showcaseEndpointConfiguration; // @synthesize showcaseEndpointConfiguration=_showcaseEndpointConfiguration;
@property(nonatomic) NSString *upsellEndpointConfiguration; // @synthesize upsellEndpointConfiguration=_upsellEndpointConfiguration;
