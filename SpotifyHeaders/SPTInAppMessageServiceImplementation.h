...
@class NSString, SPCore, SPTAllocationContext, SPTInAppMessageBannerMessageController, SPTInAppMessageBannerMessagePriorityDecider, SPTInAppMessageFeatureFlagChecks, SPTInAppMessageSettingsPageBuilder, SPTInAppMessageTriggerConfigurationsController, SPTInAppMessageTriggerEngine, SPTInAppMessageTriggerListController, SPTInAppMessageTriggerMessagePriorityDecider, SPTInAppMessageTriggerMessagingController;
...
@interface SPTInAppMessageServiceImplementation : NSObject <SPTInAppMessageFeatureFlagChecksObserver, SPTInAppMessageService>
{
    ...
    SPTInAppMessageTriggerMessagingController *_triggerMessagingController;
...
@property(retain, nonatomic) SPTInAppMessageTriggerMessagingController *triggerMessagingController; // @synthesize triggerMessagingController=_triggerMessagingController;
...
- (void).cxx_destruct;
- (void)inAppMessageFeatureFlagsDidChange:(id)arg1;
- (id)provideFeatureFlagChecker;
- (id)createTriggerMessagingController;
