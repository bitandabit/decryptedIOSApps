...
@property(readonly, nonatomic, getter=isSearchTestEnabled) _Bool searchTestEnabled;
@property(readonly, nonatomic, getter=isContinueSectionEnabled) _Bool continueSectionEnabled;
@property(readonly, nonatomic, getter=isActionsForVideoWithAudioEnabled) _Bool actionsForVideoWithAudioEnabled;
@property(readonly, nonatomic, getter=isShowsOnIPadEnabled) _Bool showsOnIPadEnabled;
@property(readonly, nonatomic, getter=isShowsCollectionFeatureEnabled) _Bool showsCollectionFeatureEnabled;
@property(readonly, nonatomic, getter=isSpeedControlEnabled) _Bool speedControlEnabled;
@property(readonly, nonatomic, getter=isShowEntityImprovementsEnabled) _Bool showEntityImprovementsEnabled;
@property(readonly, nonatomic, getter=isTabsEnabled) _Bool tabsEnabled;
@property(readonly, nonatomic, getter=isPodmarksEnabled) _Bool podmarksEnabled;
- (void)removeObserver:(id)arg1;
- (void)addObserver:(id)arg1;
- (void)dealloc;
- (id)initWithFeatureFlags:(id)arg1 localSettings:(id)arg2 productState:(id)arg3 freeTierSignal:(id)arg4 collectionTestManager:(id)arg5;
