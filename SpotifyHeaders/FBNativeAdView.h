...
@class FBAdBodyView, FBAdChoicesView, FBMediaView, FBNativeAd, FBNativeAdViewAttributes, NSArray, NSHashTable, NSString, UIButton, UIImageView, UILabel, UIViewController;
