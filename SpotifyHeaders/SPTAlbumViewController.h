...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithContextMenu:(id)arg1 albumTestManager:(id)arg2 collection:(id)arg3 collectionPlatform:(id)arg4 collectionTestManager:(id)arg5 albumViewModel:(id)arg6 productState:(id)arg7 viewLogger:(id)arg8 imageLoader:(id)arg9 glueImageLoader:(id)arg10 offlineManager:(id)arg11 albumLogger:(id)arg12 connectivityController:(id)arg13 abbaFeatureFlags:(id)arg14 collectionLogger:(id)arg15 upsellManager:(id)arg16 onDemandUpsell:(id)arg17 barButtonItemManager:(id)arg18 spotlightIndexRegistry:(id)arg19 spiderMenu:(id)arg20 linkDispatcher:(id)arg21 contributingArtistsService:(id)arg22 shareFeature:(id)arg23 modalPresentationController:(id)arg24 shelves:(id)arg25 theme:(id)arg26;
