...
- (void)play;
- (id)description;
- (id)initWithDisplayEngine:(id)arg1 audioEngine:(id)arg2 audioDecoder:(id)arg3 clock:(id)arg4 runningQueue:(id)arg5 muted:(_Bool)arg6 asyncTimebase:(_Bool)arg7 frameSeekOnPause:(_Bool)arg8;
- (void)dealloc;
