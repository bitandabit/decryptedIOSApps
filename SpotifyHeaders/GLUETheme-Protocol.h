...
- (GLUETabBarItemViewStyle *)tabBarItemViewStyle;
...
- (GLUEEntityRowStyle *)trackRowStyleWithMFT:(_Bool)arg1 subtitleStyleMetadata:(_Bool)arg2 transparentBackground:(_Bool)arg3;
- (GLUEEntityRowStyle *)calendarRowStyleWithSubtitleStyleMetadata:(_Bool)arg1 transparentBackground:(_Bool)arg2 shouldAddTrailingMargin:(_Bool)arg3;
...
- (GLUENavigationRowStyle *)navigationCellTitleAndSubtitleStyle;
- (GLUENavigationRowStyle *)navigationCellDoubleLineStyle;
