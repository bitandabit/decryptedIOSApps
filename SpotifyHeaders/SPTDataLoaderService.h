...
@class NSMapTable, NSMutableArray, NSOperationQueue, NSString, NSURLSession, SPTDataLoaderRateLimiter, SPTDataLoaderResolver, SPTDataLoaderServerTrustPolicy;

@interface SPTDataLoaderService : NSObject <SPTDataLoaderRequestResponseHandlerDelegate, NSURLSessionDataDelegate, NSURLSessionTaskDelegate>
{
