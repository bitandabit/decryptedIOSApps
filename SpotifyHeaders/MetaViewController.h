...
#import "SPTMetaViewController.h"

@class MessageBarController, NSMutableArray, NSMutableDictionary, NSOrderedSet, NSString, NSURL, NSUserDefaults, RootSettingsViewController, SPBarViewController, SPTMenuController, SPTNavigationManager, SPTObserverManager, SPTStartupTracer, StateController, UIViewController, UIViewController<SPTBarInteractiveTransitionParticipant>, UIViewController<SPTBarOverlayViewController>, UIViewController<SPTTabBarControllerProtocol>;

@interface MetaViewController : NSObject <SPTMetaViewController>
{
...
- (void)setupRootUI;
- (id)initWithWelcomeURL:(id)arg1 userDefaults:(id)arg2 startupTracer:(id)arg3 pageRegistry:(id)arg4 stateController:(id)arg5 messageBarController:(id)arg6 navigationManager:(id)arg7 notificationCenter:(id)arg8;
