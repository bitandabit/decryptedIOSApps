...
#import "SPTAppProtocolTestManagerObserver.h"
#import "SPTExternalIntegrationPlaybackControllerObserver.h"
#import "SPTService.h"
#import "SPTSpotifyAppProtocolService.h"

@class NSMapTable, NSString, SPTAllocationContext, SPTAppProtocolDelegateConnector, SPTAppProtocolEAConnector;

@interface SPTSpotifyAppProtocolServiceImplementation : NSObject <NSNetServiceDelegate, SPTAppProtocolConnectionHandlerDelegate, SPTAppProtocolConnectorDelegate, SPTExternalIntegrationPlaybackControllerObserver, SPTAppProtocolTestManagerObserver, SPTService, SPTSpotifyAppProtocolService>
{
    ...
    id <SPTAppProtocolTestManager> _testManager;
...
@property(retain, nonatomic) id <SPTAppProtocolTestManager> testManager; // @synthesize testManager=_testManager;
...
- (void).cxx_destruct;
- (void)testManager:(id)arg1 didChangeShouldEnableSocketConnectionsState:(_Bool)arg2;
- (_Bool)isPlaying;
- (void)externalIntegrationPlaybackController:(id)arg1 didReceiveNewPlayerState:(id)arg2 oldPlayerState:(id)arg3;
- (void)willEnterForeground;
- (void)didEnterBackground;
- (void)evaluateBackgroundedSocketBehavior;
