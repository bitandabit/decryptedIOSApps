...
#import "SPTUpsellManagerObserver.h"

@class NSString, NSURL, SPTPlayerTrack, UIApplication;

@interface SPTNowPlayingFeedbackBarModel : NSObject <SPTNowPlayingFeedbackManagerObserver, SPTUpsellManagerObserver, SPTPlayerObserver>
{
...
@property(copy) CDUnknownBlockType upsellCallback; // @synthesize upsellCallback=_upsellCallback;
...
- (void)upsellManager:(id)arg1 didDismissUpsellForReason:(long long)arg2;
...
- (void)action;
- (void)dealloc;
- (id)initWithFeedbackManager:(id)arg1 player:(id)arg2 playlistFeature:(id)arg3 upsellManager:(id)arg4 application:(id)arg5 psxTestManager:(id)arg6;
