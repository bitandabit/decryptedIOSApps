...
@interface SPTLoginOptions : NSObject
{
    ...
    _Bool _disallowFacebookCredentials;
...
@property(nonatomic) _Bool disallowFacebookCredentials; // @synthesize disallowFacebookCredentials=_disallowFacebookCredentials;
