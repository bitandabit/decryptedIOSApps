...
+ (void)spt_swizzleAddFreshnessFeature;
...
- (void)layoutTitlePrefixView:(struct CGSize)arg1;
@property(retain, nonatomic) UIView *titlePrefixView;
- (void)spt_swizzleLayoutSubviews;
