...
@class CADisplayLink, GLUELabel, NSString, SPTNowPlayingBaseHeadUnitController, SPTNowPlayingBaseHeadUnitView, SPTNowPlayingLogger, SPTNowPlayingModel;

@interface SPTNowPlayingAdHeadUnitViewController : SPTNowPlayingBaseHeadUnitViewController <SPTNowPlayingModelObserver, SPTNowPlayingTrackPositionObserver>
{
