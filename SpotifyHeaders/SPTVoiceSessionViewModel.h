...
@property(nonatomic) _Bool isVoiceNPVEnabled; // @synthesize isVoiceNPVEnabled=_isVoiceNPVEnabled;
...
- (id)initWithSession:(id)arg1 options:(id)arg2 audioCuePlayer:(id)arg3 deeplinkHandler:(id)arg4 testManager:(id)arg5 logger:(id)arg6 player:(id)arg7 entityDecorationController:(id)arg8 localSettings:(id)arg9;
