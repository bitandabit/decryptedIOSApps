...
@class GLUELabel, NSLayoutConstraint, NSString, SPTFreeTierUIBadgeLabelViewStateStyle, UIImageView, UIView;

@interface SPTFreeTierUIBadgeLabelView : GLUEStatefulView
{
    long long _icon;
    NSString *_text;
    SPTFreeTierUIBadgeLabelViewStateStyle *_currentStyle;
...
@property(copy, nonatomic) SPTFreeTierUIBadgeLabelViewStateStyle *currentStyle; // @synthesize currentStyle=_currentStyle;
