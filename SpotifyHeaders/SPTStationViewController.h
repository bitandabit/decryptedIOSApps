...
@class GLUEButton, GLUEEntityRowStyle, NSArray, NSString, NSURL, SPTInfoView, SPTProgressView, SPTRadioLogger, SPTStationEntityPullToRefreshView, SPTStationEntityTableHeaderView, SPTTableViewCell, SPTViewLogger;

@interface SPTStationViewController : SPTableViewController <SPTEntityTableHeaderViewNavigationBarProvider, SPTNavigationControllerNavigationBarState, SPTImageLoaderDelegate, SPTStationViewModelDelegate, SPContentInsetViewController, SPTThemableView, SPTBarButtonItemManagerObserver, SPTEntityHeaderBarButtonItemsProtocol, SPTPageController>
{
