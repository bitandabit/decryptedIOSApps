...
@class GaiaLocalAudioSessionController, GaiaMessageBarController, GaiaPlayerControl, NSString, SPNavigationController, SPTAllocationContext, SPTGaiaAirplayManager, SPTGaiaAudioAPKeepAliveHandler, SPTGaiaBackgroundController, SPTGaiaDeviceAppearanceMapping, SPTGaiaDevicePickerModel, SPTGaiaDevicePickerViewController, SPTGaiaDevicesAvailableViewFactory, SPTGaiaEducationDetailModelManager, SPTGaiaFeatureFlagsManager, SPTGaiaFeatureSettingsManager, SPTGaiaHomeDeviceAutomaticTransitionManager, SPTGaiaHomeDeviceLocalNotificationManager, SPTGaiaInstrumentationRemotePlayingStateBinder, SPTGaiaLockScreenFeatureManager, SPTGaiaLogger, SPTGaiaPlayTokenLostManager, SPTGaiaPlaybackGrabberController, SPTGaiaPopupController, SPTGaiaSavedDeviceManager, SPTGaiaSettingsManager, SPTGaiaSilentAudioPlayerProviderDefaultImplementation, SPTGaiaVolumeController, SPTPopoverController;
...
@property(retain, nonatomic) id <SPTGaiaOnboardingManager> onboardingManager; // @synthesize onboardingManager=_onboardingManager;
