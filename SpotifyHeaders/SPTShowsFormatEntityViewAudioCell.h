...
@class GLUEAccessoryIconButton, GLUEImageView, NSString, SPTShowsFormatCellViewModel;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) GLUEAccessoryIconButton *cellAccessoryButton;
