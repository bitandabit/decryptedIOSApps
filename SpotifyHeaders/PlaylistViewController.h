...
@property(nonatomic) __weak id <SPTSpotlightIndexRegistry> spotlightIndexRegistry; // @synthesize spotlightIndexRegistry=_spotlightIndexRegistry;
...
- (void)toggleFollowingView:(_Bool)arg1 animated:(_Bool)arg2 forFollowButton:(id)arg3;
