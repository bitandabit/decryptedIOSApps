...
@class NSString, SPTObserverManager, SPTVoiceCommand, SPTVoiceRecognitionTask, SPTask;

@interface SPTVoiceSessionImplementation : NSObject <SPTVoiceRecognitionTaskDelegate, SPTVoiceSession>
{
...
- (void)pausePlaybackIfNeededWithCompletion:(CDUnknownBlockType)arg1;
...
- (id)initWithVoiceRecognitionTaskFactory:(id)arg1 audioSessionManager:(id)arg2 voiceCommandHandler:(id)arg3 player:(id)arg4 utteranceIdProvider:(id)arg5 initialUtteranceId:(id)arg6;
