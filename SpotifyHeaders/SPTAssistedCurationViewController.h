...
#import "SPTAssistedCurationCardCellConfiguratorDelegate.h"
#import "SPTAssistedCurationCardCellLogDelegate.h"
#import "SPTAssistedCurationSearchButtonDelegate.h"
#import "SPTAssistedCurationViewModelDelegate.h"
...
@class NSString, SPTAssistedCurationCardCellConfigurator, SPTAssistedCurationCardStyle, SPTAssistedCurationGLUETheme, SPTAssistedCurationInfoView, SPTAssistedCurationLogger, SPTAssistedCurationSearchButton, UIActivityIndicatorView, UICollectionView, UIPageControl, UITapGestureRecognizer;

@interface SPTAssistedCurationViewController : UIViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, SPTNavigationControllerNavigationBarState, UIScrollViewDelegate, SPTAssistedCurationSearchButtonDelegate, SPTAssistedCurationCardCellLogDelegate, SPTAssistedCurationCardCellConfiguratorDelegate, SPTAssistedCurationViewModelDelegate>
{
...
- (void)scrollToCardAtIndex:(unsigned long long)arg1;
