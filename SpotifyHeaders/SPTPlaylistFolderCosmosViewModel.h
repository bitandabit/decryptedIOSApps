...
#import "SPTPlaylistFolderViewModel.h"
...
- (id)initWithPlaylistDataLoader:(id)arg1 folderURL:(id)arg2 logger:(id)arg3 playlistModel:(id)arg4 offlineManager:(id)arg5 playlistSynchroniser:(id)arg6;
