...
- (void)onboarding:(const shared_ptr_60e8759c *)arg1 enabled:(_Bool)arg2;
- (void)remoteTransfer:(const shared_ptr_640f0fe2 *)arg1 error:(int)arg2;
- (id)findDevice:(id)arg1 withType:(long long)arg2;
- (void)activateDevice:(id)arg1 withCallback:(CDUnknownBlockType)arg2;
- (shared_ptr_60e8759c)getDeviceBeingActivatedNonConst;
- (shared_ptr_60e8759c)getActiveDeviceNonConst;
- (void)handleDeviceBeingActivatedChanged:(id)arg1;
- (void)handleActiveDeviceChanged:(id)arg1 forceNotify:(_Bool)arg2;
- (id)getOrCreateGaiaDeviceFromCpp:(shared_ptr_60e8759c)arg1;
...
- (void)invalidate;
- (void)dealloc;
- (id)initWithGaiaManager:(struct GaiaManagerInterface *)arg1 offlineMode:(id)arg2 scheduler:(id)arg3 canonicalUsername:(id)arg4;
