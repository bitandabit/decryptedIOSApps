...
@property(retain, nonatomic) id <SPTSpiderGestureRegistry> spiderGestureRegistry; // @synthesize spiderGestureRegistry=_spiderGestureRegistry;
...
- (void)enableSpiderMenuOnCell:(id)arg1;
...
- (id)initWithTrack:(id)arg1 viewModel:(id)arg2 platformManager:(id)arg3 theme:(id)arg4 contextMenuPresenterFactory:(id)arg5 contextMenuOptionsFactory:(id)arg6 shelves:(id)arg7 spiderGestureRegistry:(id)arg8 upsellManager:(id)arg9 onDemandUpsell:(id)arg10 testManager:(id)arg11 explicitContentAccessManager:(id)arg12 logger:(id)arg13;
