...
#import "SPTExternalIntegrationPlatform.h"
...
- (void).cxx_destruct;
- (id)initWithCollectionController:(id)arg1 contentController:(id)arg2 driverDistractionController:(id)arg3 playbackController:(id)arg4 radioController:(id)arg5 searchController:(id)arg6;
