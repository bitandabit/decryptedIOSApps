...
#import "SPTInAppMessageQAToolViewModelContentDelegate.h"
#import "SPTSlateDataSource.h"
#import "SPTSlateDelegate.h"
#import "SPTSlateViewDelegate.h"

@class NSString, SPTInAppMessageQAToolViewModel;

@interface SPTInAppMessageQAToolPresentationController : NSObject <SPTSlateDelegate, SPTSlateDataSource, SPTSlateViewDelegate, SPTInAppMessageQAToolViewModelContentDelegate>
{
    _Bool _presented;
    id <SPTInAppMessageQAToolPresentationControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <SPTInAppMessageQAToolPresentationControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (id)provideSlate;
...
- (id)initWithViewModel:(id)arg1 slateBuilderProvider:(id)arg2 slateManager:(id)arg3;
