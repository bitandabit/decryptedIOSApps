...
@class NSString, NSURL, SPTFreeTierRecoverAccountResetPasswordView, SPTFreeTierRecoverAccountResetPasswordViewModel;
...
@interface SPTFreeTierRecoverAccountResetPasswordViewController : UIViewController <UITextFieldDelegate, SPTFreeTierRecoverAccountResetPasswordViewModelDelegate, SPTPageController, SPTFreeTierRecoverAccountSlateContentUnit>
{
    ...
    SPTFreeTierRecoverAccountResetPasswordView *_passwordRecoverView;
...
@property(retain, nonatomic) SPTFreeTierRecoverAccountResetPasswordView *passwordRecoverView; // @synthesize passwordRecoverView=_passwordRecoverView;
...
- (void)changeContentWithViewController:(id)arg1;
