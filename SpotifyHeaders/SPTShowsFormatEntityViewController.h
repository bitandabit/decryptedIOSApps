...
@interface SPTShowsFormatEntityViewController : UIViewController <SPTBarButtonItemManagerObserver, SPTFormatListPlatformManagerOfflineDelegate, SPTShowsFormatEntityViewModelDelegate, SPTContextMenuPresenterDelegate, SPTShareableContext, SPTShareScreenshotObserverManagerDataSource, SPTPageController>
{
...
- (void)loadView;
- (void)dealloc;
- (id)initWithViewModel:(id)arg1 viewDataSource:(id)arg2 viewDelegate:(id)arg3 imageLoaderFactory:(id)arg4 contextMenuFeature:(id)arg5 podcastContextMenuProvider:(id)arg6 formatListPlatformManager:(id)arg7 barButtonItemManager:(id)arg8 logger:(id)arg9 contextAwareSharingEnabled:(_Bool)arg10 collectionTestManager:(id)arg11 shareFeature:(id)arg12 alertController:(id)arg13;
