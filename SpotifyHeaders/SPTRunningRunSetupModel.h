...
@class NSArray, NSDictionary, NSString, NSTimer, NSURL, SPTDataLoader, SPTPlayerState, SPTRunningAudioUXManager, SPTRunningPlaybackManagerListImplementation, SPTRunningStepManager, SPTUser;
...
@property(retain, nonatomic) id <SPTDataLoaderCancellationToken> audioUXCancellationToken; // @synthesize audioUXCancellationToken=_audioUXCancellationToken;
...
@property(nonatomic) __weak id <SPTRunningRunSetupModelDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
