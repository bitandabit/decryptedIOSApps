...
@class NSString, SPTAllocationContext, SPTFreeTierSignupUserInfoModel;

@interface SPTFreeTierSignupServiceImplementation : NSObject <SPTPageRegistryObserver, SPTService>
{
