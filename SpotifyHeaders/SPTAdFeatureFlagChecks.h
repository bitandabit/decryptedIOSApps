...
@interface SPTAdFeatureFlagChecks : NSObject <SPTProductStateObserver, SPTLocalSettingsObserver, SPTAbbaFeatureFlagsObserver>
{
    ...
    id <SPTLegacyFeatureFlag> _nielsenMeasurementFlag;
...
@property(readonly, nonatomic) id <SPTLegacyFeatureFlag> nielsenMeasurementFlag; // @synthesize nielsenMeasurementFlag=_nielsenMeasurementFlag;
...
@property(readonly, nonatomic, getter=isAdPreferencesSurveyEnabled) _Bool adPreferencesSurveyEnabled;
@property(readonly, nonatomic, getter=isAdFeedbackEnabled) _Bool adFeedbackEnabled;
@property(readonly, nonatomic, getter=isFacebookAudienceNetworkEnabled) _Bool facebookAudienceNetworkEnabled;
@property(readonly, nonatomic, getter=isAudioAdLearnMoreButtonEnabled) _Bool audioAdLearnMoreButtonEnabled;
...
@property(readonly, nonatomic, getter=isNielsenMeasurementEnabled) _Bool nielsenMeasurementEnabled;
@property(readonly, nonatomic, getter=isMVTOFeedbackEnabled) _Bool MVTOFeedbackEnabled;
