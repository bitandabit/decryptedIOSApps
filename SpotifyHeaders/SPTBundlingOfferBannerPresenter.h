...
#import "SPTBundlingBannerViewModelDelegate.h"
#import "SPTOfflineModeStateObserver.h"

@class NSNotificationCenter, NSString, SPTBundlingOffer, SPTBundlingOfferLogger, SPTBundlingTestManager;

@interface SPTBundlingOfferBannerPresenter : NSObject <SPTBundlingBannerViewModelDelegate, SPTOfflineModeStateObserver>
{
