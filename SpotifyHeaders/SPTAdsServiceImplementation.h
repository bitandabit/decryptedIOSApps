...
@class NSString, NSURL, SPTAdContextManager, SPTAdCosmosBridge, SPTAdFeatureFlagChecks, SPTAdFeaturedActionHandler, SPTAdFocusManager, SPTAdGlobalSettingsController, SPTAdLinkHandler, SPTAdLocalNotificationManager, SPTAdMobileOverlayController, SPTAdMovementLogger, SPTAdNowPlayingManager, SPTAdOptInManager, SPTAdRegistry, SPTAdRulesManager, SPTAdSponsoredSessionContentUnitProvider, SPTAdSponsoredSessionController, SPTAdStateLogger, SPTAdVideoEventReporter, SPTAdsActivityLogger, SPTAdsAutoDetectionController, SPTAdsMoatManager, SPTAdsViewModel, SPTAllocationContext, SPTFacebookAdCoordinator, SPTSponsoredContextManager;
...
@interface SPTAdsServiceImplementation : NSObject <SPTAdFeatureFlagChecksObserver, SPSessionObserver, SPTAdsService>
{
    ...
    SPTFacebookAdCoordinator *_fbAdCoordinator;
...
@property(retain, nonatomic) SPTFacebookAdCoordinator *fbAdCoordinator; // @synthesize fbAdCoordinator=_fbAdCoordinator;
...
- (id)provideAdPreviewViewController;
