...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithModelOperation:(id)arg1 imageLoader:(id)arg2 session:(id)arg3 shelves:(id)arg4 theme:(id)arg5 options:(unsigned long long)arg6 localizedFeatureName:(id)arg7 featureId:(id)arg8 viewDecorator:(id)arg9 pageIdentifier:(id)arg10 barButtonItemManager:(id)arg11;
