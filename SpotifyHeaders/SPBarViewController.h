...
@class NSHashTable, NSMutableArray, NSString, SPTBarAttachmentContainerViewController, SPTBarInteractivePresentationController, UIViewController<SPTBarInteractiveTransitionParticipant>, UIViewController<SPTBarOverlayViewController>;
