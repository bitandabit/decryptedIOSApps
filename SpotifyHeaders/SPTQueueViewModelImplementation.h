...
#import "SPTQueueViewModel.h"

@class NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, SPTNowPlayingEntityDecorationController, SPTPlayerQueue, SPTQueueViewModelDataSource;

@interface SPTQueueViewModelImplementation : NSObject <SPTPlayerObserver, SPTPlayerQueueObserver, SPTProductStateObserver, SPTNowPlayingEntityDecorationControllerObserver, SPTExplicitContentEnabledStateObserver, SPTQueueViewModel>
{
...
- (_Bool)isTrackExplicitContentPlaybackRestricted:(id)arg1;
- (_Bool)isPlayerTrackExplicitContentPlaybackRestricted:(id)arg1;
...
- (id)initWithPlayer:(id)arg1 productState:(id)arg2 playbackDelegateRegistry:(id)arg3 entityDecorationController:(id)arg4 logCenter:(id)arg5 addToUpNextBehavior:(unsigned long long)arg6 explicitContentAccessManager:(id)arg7;
