...
@class NSString, SPTCarPlayLoggedInDataSource, SPTCarPlayTestManager;

@interface SPTCarPlayDataSourceStateManager : NSObject <SPTOfflineModeStateObserver>
{
...
- (void)setupLoggedInDataSourcesWithTestManager:(id)arg1 externalIntegrationPlatform:(id)arg2 imageLoaderFactor:(id)arg3 playerFeature:(id)arg4 offlineModeState:(id)arg5;
