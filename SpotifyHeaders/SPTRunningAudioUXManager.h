...
@class AVQueuePlayer, FBKVOController, NSDictionary, NSString, NSTimer, SPSession, SPTAudioSessionActivator, SPTRunningAudioUXCache;
...
@property(retain, nonatomic) NSTimer *volumeStepTimer; // @synthesize volumeStepTimer=_volumeStepTimer;
